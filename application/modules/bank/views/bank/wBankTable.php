            ...
            <table class="table table-striped" style="width:100%">
				...
				<?php if($aDataList['rtCode'] == 1 ):?>
                    <?php foreach($aDataList['raItems'] AS $key=>$aValue){ ?>
                        <tr class="text-center xCNTextDetail2 otrCoupon" id="otrCoupon<?=$key?>" data-code="<?=$aValue['FTBnkCode']?>" data-name="<?=$aValue['FTBnkName']?>">
							<?php if($aAlwEvent['tAutStaFull'] == 1 || $aAlwEvent['tAutStaDelete'] == 1) : ?>
							...
							<?php if($aAlwEvent['tAutStaFull'] == 1 || $aAlwEvent['tAutStaDelete'] == 1) : ?>
								<td><img class="xCNIconTable xCNIconDel" src="<?= base_url().'/application/modules/common/assets/images/icons/delete.png'?>" onClick="JSnAgencyDel('<?php echo $nCurrentPage?>','<?=$aValue['FTBnkName']?>','<?php echo $aValue['FTBnkCode']?>','<?= language('common/main/main','tModalConfirmDeleteItemsYN')?>')"></td>
							<?php endif; ?>
							<?php if($aAlwEvent['tAutStaFull'] == 1 || $aAlwEvent['tAutStaRead'] == 1) : ?>
								<td><img class="xCNIconTable" src="<?= base_url().'/application/modules/common/assets/images/icons/edit.png'?>" onClick="JSvCallPageAgencyEdit('<?php echo $aValue['FTBnkCode']?>','<?php echo $aValue[''] ?>','<?php echo $aValue['']?>')"></td>
							<?php endif; ?>
                        </tr>
                    <?php } ?>
                <?php else:?>
