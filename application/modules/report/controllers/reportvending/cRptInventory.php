...
class cRptInventory extends MX_Controller {
    ...
    private function init($paParams = []) {
        $this->aText = [
            ...
            // Table Label
            'tRptAdjStkVDTotalFooter' => language('report/report/report', 'tRptTotalFooter'),
    ...
    */
    public function FSvCCallRptRenderExcel($paParams = []) {
        try {
            ...
            $aDataReport = $this->mRptInventory->FSaMGetDataReport($aGetDataReportParams);
            /*============ End Get Data ======================================*/
            ...
            if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
                ...
                $objPHPExcel->setActiveSheetIndex(0)
                    ->setCellValue('A' . $nStartRowHeadder, $this->aText['tRptCabinetCode'])
                    ->setCellValue('B' . $nStartRowHeadder, $this->aText['tRptPdtCode'])
                    ->setCellValue('C' . $nStartRowHeadder, $this->aText['tRptPdtName'])
                    ->setCellValue('D' . $nStartRowHeadder, $this->aText['tRptCabinetclass'])
                    ->setCellValue('E' . $nStartRowHeadder, $this->aText['tRptCabinetCollum'])
                    ->setCellValue('F' . $nStartRowHeadder, $this->aText['tRptCabinetnumber'])
                    ->setCellValue('G' . $nStartRowHeadder, $this->aText['tRptCabinetCost'])
                    ->setCellValue('H' . $nStartRowHeadder, $this->aText['tRptCabinetTotalcost']);
                ...
                if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
                    ...
                    foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                        ...
                        $objPHPExcel->setActiveSheetIndex(0)
                                ...
                                ->setCellValue('F' . $nStartRowData, number_format($aValue["FCStkQty"], $this->nOptDecimalShow))
                                ->setCellValue('G' . $nStartRowData, number_format($aValue["FCPdtCostEx"], $this->nOptDecimalShow))
                                ->setCellValue('H' . $nStartRowData, number_format($aValue["CostExQty"], $this->nOptDecimalShow));
                        ...
                        $nSumFooterFCStkQty = number_format($aValue["FCStkQty_Footer"], $this->nOptDecimalShow);
                        $nSumFooterPdtCostEx = number_format($aValue["FCPdtCostEx_Footer"], $this->nOptDecimalShow);
                        $nSumFooterCostExQty = number_format($aValue["CostExQty_Footer"], $this->nOptDecimalShow);
