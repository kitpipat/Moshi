...
class cRptSaleShopByShop extends MX_Controller {
    ...
    public function index() {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptSaleShopByShop->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase) {
        try {
            ...
            // Get Data Report
            $aDataReport = $this->mRptSaleShopByShop->FSaMGetDataReport($aDataWhere, $this->aRptFilter);
            /*===== End Get Data =======================================================*/
    ...
    public function FSvCCallRptViewBeforePrintClickPage() {
        ...
        $aDataReport = $this->mRptSaleShopByShop->FSaMGetDataReport($aDataWhere, $aDataFilter);
        /*===== End Get Data ===========================================================*/
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase = []) {
        ...
        try {
            ...
            $nDataCountPage = $this->mRptSaleShopByShop->FSaMCountDataReportAll($aDataCountData);
