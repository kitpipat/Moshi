...
class cRptProductSalesPosVD365 extends MX_Controller {
    ...
    */
    ...
    public function __construct() {
        ...
        $this->load->model('report/reportsalespecial/mRptProductSalesPosVD365');
        $this->init();
        parent::__construct();
    }
    ...
    private function init(){
        $this->aText    = [
            'tTitleReport'          => language('report/report/report','tRptTitleProductSalesPosVD365'),
    ...
    public function index() {
        if(!empty($this->tRptCode) && !empty($this->tRptExportType)){
            $this->mRptProductSalesPosVD365->FSnMExecStoreReport($this->aRptFilter);
   ...
   /**
     ...
     * Creator: 29/01/2020 Saharat(Golf)
     * LastUpdate: 
    ...
    */
    public function FSvCCallRptViewBeforePrint() {
        ...
        $aDataReport = $this->mRptProductSalesPosVD365->FSaMGetDataReport($aDataWhereRpt);
        ...
        $tRptView = JCNoHLoadViewAdvanceTable('report/datasources/reportsalespecial/rptproductsalesposvd365', 'wRptProductSalePosVD365Html', $aDataViewRpt);
     ...
     * LastUpdate: 29/01/2020 Saharat(Golf)
     * Return: View Report Viewer
     * ReturnType: View
     */
    ...
    public function FSoCChkDataReportInTableTemp(){
        try {
            ...
            $nDataCountPage = $this->mRptProductSalesPosVD365->FSnMCountRowInTemp($aDataCountData);
            $aResponse = array(
