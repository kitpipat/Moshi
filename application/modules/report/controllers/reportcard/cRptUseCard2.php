...
class cRptUseCard2 extends MX_Controller {
    ...
    private function init() {
        ...
        $this->aRptFilter = [
            ...
            // สาขา
            'tRptBchCodeFrom'    => !empty($this->input->post('oetRptBchCodeFrom')) ? $this->input->post('oetRptBchCodeFrom') : '',
            'tRptBchNameFrom'    => !empty($this->input->post('oetRptBchNameFrom')) ? $this->input->post('oetRptBchNameFrom') : '',
            'tRptBchCodeTo'      => !empty($this->input->post('oetRptBchCodeTo')) ? $this->input->post('oetRptBchCodeTo') : '',
            'tRptBchNameTo'      => !empty($this->input->post('oetRptBchNameTo')) ? $this->input->post('oetRptBchNameTo') : '',
