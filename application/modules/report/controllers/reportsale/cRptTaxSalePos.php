    ...
    public function FSvCCallRptExportFile()
    {
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                ...
                $cFCXshAmt = number_format(empty($aValue['FCXshAmt']) ? 0 : $aValue['FCXshAmt']);
                $cFCXshVat = number_format(empty($aValue['FCXshVat']) ? 0 : $aValue['FCXshVat']);
                $cFCXshAmtNV = number_format(empty($aValue['FCXshAmtNV']) ? 0 : $aValue['FCXshAmtNV']);
                $cFCXshGrandTotal = number_format(empty($aValue['FCXshGrandTotal']) ? 0 : $aValue['FCXshGrandTotal']);
                ...
                if (($nKey + 1) == count($aDataReport['aRptData'])) { //SumFooter
                    $values = [
                        ...
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(number_format($cFCXshAmt_Footer,4)),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(number_format($cFCXshVat_Footer,4)),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(number_format($cFCXshAmtNV_Footer,4)),
                        WriterEntityFactory::createCell(null),
                        WriterEntityFactory::createCell(number_format($cFCXshGrandTotal_Footer,4)),
                        WriterEntityFactory::createCell(null),
                    ];
