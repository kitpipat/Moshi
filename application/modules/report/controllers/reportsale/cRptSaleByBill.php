...
class cRptSaleByBill extends MX_Controller
{
    ...
    public function FSvCCallRptRenderExcel()
    {
        ...
        if (isset($aDataReport['raItems']) && !empty($aDataReport['raItems'])) {
            foreach ($aDataReport['raItems'] as $nKey => $aValue) {
                ...
                $tFDXshDocDate = empty($aValue['FDXshDocDate']) ? '' : date('Y-m-d H:i:s', strtotime($aValue['FDXshDocDate']));
    ...
    public function FSoCCallRptRenderHedaerExcel()
    {
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell($this->aText['tRptFaxNo'] . ' ' . $this->aCompanyInfo['FTCmpFax']),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
