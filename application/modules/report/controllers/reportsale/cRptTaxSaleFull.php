...
class cRptTaxSaleFull extends MX_Controller
{
    ...
    public function FSvCCallRptRenderExcel()
    {
        ...
        if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) {
            ...
            foreach ($aDataReport['aRptData'] as $nKey => $aValue) {
                ...
                $cFCXshAmt = number_format(empty($aValue['FCXshAmt']) ? 0 : $aValue['FCXshAmt'],4);
                $cFCXshVat = number_format(empty($aValue['FCXshVat']) ? 0 : $aValue['FCXshVat'],4);
                $cFCXshAmtNV = number_format(empty($aValue['FCXshAmtNV']) ? 0 : $aValue['FCXshAmtNV'],4);
                $cFCXshGrandTotal = number_format(empty($aValue['FCXshGrandTotal']) ? 0 : $aValue['FCXshGrandTotal'],4);
                ...
                $cFCXshAmt_Footer = number_format(empty($aValue['FCXshAmt_Footer']) ? 0 : $aValue['FCXshAmt_Footer'],4);
                $cFCXshVat_Footer = number_format(empty($aValue['FCXshVat_Footer']) ? 0 : $aValue['FCXshVat_Footer'],4);
                $cFCXshAmtNV_Footer = number_format(empty($aValue['FCXshAmtNV_Footer']) ? 0 : $aValue['FCXshAmtNV_Footer'],4);
                $cFCXshGrandTotal_Footer = number_format(empty($aValue['FCXshGrandTotal_Footer']) ? 0 : $aValue['FCXshGrandTotal_Footer'],4);
            }
        }
    ...
    public function FSoCCallRptRenderHedaerExcel()
    {
        ...
        $aCells = [
            ...
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell($this->aText['tRptAddrFax'] . ' ' . $this->aCompanyInfo['FTCmpFax']),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
            WriterEntityFactory::createCell(null),
