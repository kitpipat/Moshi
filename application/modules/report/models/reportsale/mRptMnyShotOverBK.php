...
class mRptMnyShotOver extends CI_Model {
    ...
    public function FSnMExecStoreReport($paDataFilter) {
        ...
        // /แคชเชีย
        $tCstCodeSelect = ($paDataFilter['bCstStaSelectAll']) ? '' : FCNtAddSingleQuote($paDataFilter['tCstCodeSelect']);
        ...
        $aDataStore = array(
            ...
            'ptUsrF'        => $paDataFilter['tCstCodeFrom'],
            'ptUsrT'        => $paDataFilter['tCstCodeTo'],
