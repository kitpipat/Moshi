<style>
    ...
    .xCNBTNConditionActive:hover , .xCNBTNConditionBetween:hover {
    ...
    .xCNTableBorderSub thead th, .xCNTableBorderSub>thead>tr>th, .xCNTableBorderSub tbody tr , .xCNTableBorderSub>tbody>tr>td{
    ...
    .xCNButtonNewUI > .xCNIconFind , .xCNIconCalendar{
        width       : 18px;
    }
                                        ...
                                        <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                                            <div class='form-group'>
                                                <div class='input-group'>
                                                    ...
                                                    <input type='text' class='form-control xCNHide xWRptAllInput' id='oetRptBchCodeSelect' name='oetRptBchCodeSelect'>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <table class="table table-bordered xCNTableBorderSub">
                    <thead>
                        <tr>
                            <th style="width: 21.25%;"><p class="xCNFontTDGroupFilter"><?=language('report/report/report', 'tRptHeadConditionReportETC')?></p></th>
                            <th style="width: 5%;"><p class="xCNFontTDGroupFilter" style="text-align: center;"><?=language('report/report/report', 'tRptAll')?></p></th>
                            <th style="width: 30%;"><p class="xCNFontTDGroupFilter"><?=language('report/report/report', 'tRptCoditionFrom')?></p></th>
                            <th style="width: 30%;"><p class="xCNFontTDGroupFilter"><?=language('report/report/report', 'tRptCoditionTo')?></p></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php 
                                                ...
                                                <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                                                    <div class='xCNInputNewUIBrowse'>
                                                        <div class='input-group' style='width: 100%;'>
                                                            ...
                                                            <span class='input-group-btn'>
                                                                <button id='obtRPTBrowseBookBankFrom' type='button' class='btn xCNButtonNewUI'><img class='xCNIconFind'></button>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                                                    <div class='xCNInputNewUIBrowse'>
                                                        <div class='input-group' style='width: 100%;'>
                                                            ...
                                                            <span class='input-group-btn'>
                                                                <button id='obtRPTBrowseBookBankTo' type='button' class='btn xCNButtonNewUI'><img class='xCNIconFind'></button>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <?php if (!in_array($aRptFilValue['FTRptFltCode'], ["1","2","3","6","4","38"])){ ?>
                                ...
                                <?php if($tGroupFilter != $aRptFilValue['FTRptGrpFlt']){ ?>
                                    ...
                                    <tr class="xCNNewGroup">
                                        <td><p class="xCNFontTDGroupFilter"><?=$tTextGroup;?></p></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                    </tr>
                                ...
                                <tr class='xCNDataCondition'>
                                    <td><p class='xCNLabelTBText'><?=$aRptFilValue['FTRptFltName'];?></p></td>
                                    <td>
...
<script>
    ...
    $('.xCNClickConditionSelect').click(function(){
        ...
        $('.xCNTextLabelMargin').css({"margin": "5px 0px 22px 0px"});
