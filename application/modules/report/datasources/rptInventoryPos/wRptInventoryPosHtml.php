                                ...
                                <?php
                                    ...
                                    if($nRowPartID == $nGroupMember){
                                        ...
                                        if($nCountDataAll - 1 != $nKey){
                                            echo "<tr><td class='xCNRptGrouPing' colspan='4' style='border-top: dashed 1px #333 !important;'></td></tr>";
                                        }
                                    ...
                                    $tFCPdtCostTotal    = number_format($aValue["FCPdtCostTotal"], $nOptDecimalShow);
