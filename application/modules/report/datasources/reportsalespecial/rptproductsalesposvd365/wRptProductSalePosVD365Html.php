        ...
        <div class="xCNContentReport">
            <div id="odvRptTableAdvance" class="table">
                <table class="table">
                    <thead>
                        <tr>
                            <th nowrap class="text-center xCNRptColumnHeader" style="width:5%;"><?php echo @$aDataTextRef['tRptProductSalesPosVDDate'];?></th>
                            <th nowrap class="text-left xCNRptColumnHeader"   style="width:5%;"><?php echo @$aDataTextRef['tRptProductSalesPosVDPos'];?></th>
                            <th nowrap class="text-left xCNRptColumnHeader"   style="width:8%;"><?php echo @$aDataTextRef['tRptProductSalesPosVDDocNo'];?></th>
                            <th nowrap class="text-left xCNRptColumnHeader"   style="width:5%;"><?php echo @$aDataTextRef['tRptProductSalesPosPayment'];?></th>
                            <th nowrap class="text-left xCNRptColumnHeader"   style="width:20%;"><?php echo @$aDataTextRef['tRptProductSalesPosProduct'];?></th>
                            <th nowrap class="text-right xCNRptColumnHeader"  style="width:5%;"><?php echo @$aDataTextRef['tRptProductSalesPosSum'];?></th>
                        </tr>
                    </thead>
                    <tbody> 
                        <?php
