            ...
            <div class="row">
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                    <?php if(isset($aCompanyInfo) && !empty($aCompanyInfo)) {?>
                        ...
                        <div class="text-left xCNRptAddress">
                            <label ><?=$aDataTextRef['tRptTaxSalePosByDateTel'] . $aCompanyInfo['FTCmpTel'] ?> <?= $aDataTextRef['tRptAddrFax'] . $aCompanyInfo['FTCmpFax'] ?></label>
                        </div>
                        <div class="text-left xCNRptAddress">
                        ...
                        <?php if(isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) { ?>
                            ...
                            <?php foreach ($aDataReport['aRptData'] as $nKey => $aValue) { ?>
                                <?php
                                    ...
                                    FCNtHRPTHeadGrouppingRptLevel5($nRowPartID, $aGrouppingData);
                                    ...
                                    FCNtHRPTHeadGrouppingRptLevel4($nRowPartIDPos, $aGrouppingData);
