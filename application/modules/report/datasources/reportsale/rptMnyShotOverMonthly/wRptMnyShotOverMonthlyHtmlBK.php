            ...
            <table class="table " >
                    ...
                    ?>
                        <tr>
                            ...
                            <td  class="text-right xCNRptDetail" style="width:5%;  border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FCMnyShot'],2); ?></td>
                        ...
                        ?>
                              <?php 
                                ...
                                <tr style="border-bottom: 1px solid black !important">   
                                    <td colspan ="2" class="text-center xCNRptDetail"><?php echo $aDataTextRef['tRptTotalFooter']; ?></td>    
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD1_Footer'],2);?></td>  
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD2_Footer'],2);?></td>  
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD3_Footer'],2);?></td>  
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD4_Footer'],2);?></td>  
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD5_Footer'],2);?></td>  
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD6_Footer'],2);?></td>  
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD7_Footer'],2);?></td>  
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD8_Footer'],2);?></td>  
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD9_Footer'],2);?></td>
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD10_Footer'],2);?></td> 
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD11_Footer'],2);?></td> 
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD12_Footer'],2);?></td> 
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD13_Footer'],2);?></td> 
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD14_Footer'],2);?></td> 
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD15_Footer'],2);?></td> 
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD16_Footer'],2);?></td> 
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD17_Footer'],2);?></td> 
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD18_Footer'],2);?></td> 
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD19_Footer'],2);?></td> 
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD20_Footer'],2);?></td> 
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD21_Footer'],2);?></td> 
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD22_Footer'],2);?></td> 
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD23_Footer'],2);?></td> 
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD24_Footer'],2);?></td> 
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD25_Footer'],2);?></td> 
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD26_Footer'],2);?></td> 
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD27_Footer'],2);?></td> 
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD28_Footer'],2);?></td> 
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD29_Footer'],2);?></td> 
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD30_Footer'],2);?></td> 
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FTDayD31_Footer'],2);?></td> 
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FCShotOver_Footer'],2);?></td> 
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FCMnyShot_Footer'],2);?></td> 
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FCMnyOver_Footer'],2);?></td> 
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FCSvnCashIn_Footer'],2);?></td> 
                                    <td class="text-center xCNRptDetail" style="border-left: 1px dashed #ccc !important; border-right: 1px dashed #ccc !important;"><?php echo number_format($aData['FCSvnCashOut_Footer'],2);?></td> 
