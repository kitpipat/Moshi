...
class mReport extends CI_Model {
    ...
    public function FSaMDataRptMunuList($paWhereData) {
        ...
        $tSQL = " SELECT
                            ...
                            LEFT JOIN TCNTUsrFuncRpt AS UMNRPT WITH(NOLOCK) ON USR.FTRolCode = UMNRPT.FTRolCode
        ...
        if (isset($paDataReport) && !empty($paDataReport['FTRptFilterCol'])) {
            ...
            foreach ($aDataCondSplit AS $nKey => $tRptFilterCode) {
                $tSQL = " SELECT
                            ...
                            LEFT JOIN TSysReportFilter_L AS TSRPTF_L WITH(NOLOCK) ON TSRPTF.FTRptFltCode = TSRPTF_L.FTRptFltCode AND TSRPTF_L.FNLngID = 1
