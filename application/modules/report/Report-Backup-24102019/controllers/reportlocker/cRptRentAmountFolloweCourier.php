...
class cRptRentAmountFolloweCourier extends MX_Controller {
    ...
    private function init() {
        $this->aText = [
            ...
            // in report
            'tRptRentAmtFolCourStaPaymentNoPay' => language('report/report/report', 'tRptRentAmtFolCourStaPaymentNoPay'),
            'tRptRentAmtFolCourStaPaymentSome' => language('report/report/report', 'tRptRentAmtFolCourStaPaymentSome'),
            'tRptRentAmtFolCourStaPaymentAlready' => language('report/report/report', 'tRptRentAmtFolCourStaPaymentAlready'),
            'tRptRentAmtFolCourSumText' => language('report/report/report', 'tRptRentAmtFolCourSumText'),
            'tRptRentAmtFolCourSumTextLast' => language('report/report/report', 'tRptRentAmtFolCourSumTextLast'),
