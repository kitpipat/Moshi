...
class cRptChangeStaSale extends MX_Controller {
    ...
    public function index() {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptChangeStaSale->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase) {
        ...
        // Get Data Report
        $aDataReport = $this->mRptChangeStaSale->FSaMGetDataReport($aDataWhere, $this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrintClickPage() {
        ...
        $aDataReport = $this->mRptChangeStaSale->FSaMGetDataReport($aDataWhere, $aDataFilter);
    ...
    public function FSvCCallRptRenderExcel($paDataSwitchCase) {
        try {
            ...
            $aDataReport = $this->mRptChangeStaSale->FSaMGetDataReport($aDataWhere); //Get Data
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase) {
        ...
        try {
            ...
            $nDataCountPage = $this->mRptChangeStaSale->FSaMCountDataReportAll($aDataCountData);
