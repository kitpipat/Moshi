...
class cRptDropByDate extends MX_Controller {
    ...
    private function init() {
        $this->aText = [
            ...
            'tRptReceived' => language('report/report/report', 'tRptReceived'),
            'tRptNotReceived' => language('report/report/report', 'tRptNotReceived'),
        ];
    ...
    public function index() {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptDropByDate->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase) {
        ...
        // Get Data Report
        $aDataReport = $this->mRptDropByDate->FSaMGetDataReport($aDataWhere, $this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrintClickPage() {
        ...
        $aDataReport = $this->mRptDropByDate->FSaMGetDataReport($aDataWhere, $aDataFilter);
    ...
    public function FSvCCallRptRenderExcel($paDataSwitchCase) {
        try {
            ...
            $aDataTextRef = array(
                'tTitleReport' => language('report/report/report', 'tRptTitleRptDropByDate'),
                'tRptTaxNo' => language('report/report/report', 'tRptTaxNo'),
                'tRptDatePrint' => language('report/report/report', 'tRptDatePrint'),
                'tRptDateExport' => language('report/report/report', 'tRptDateExport'),
                'tRptTimePrint' => language('report/report/report', 'tRptTimePrint'),
                ...
                'tRptDropByDate' => language('common/main/main', 'tCMNNotFoundData'),
                // Address Lang
            ...
            $aDataReport = $this->mRptDropByDate->FSaMGetDataReport($aDataWhere); //Get Data
            ...
            if ($aDataReport['rtCode'] == 1) {
                ...
                $objPHPExcel->setActiveSheetIndex(0)->setCellValue('A' . $nStartRowData, $aDataTextRef['tRptDropByDate']);
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase) {
        ...
        try {
            ...
            $nDataCountPage = $this->mRptDropByDate->FSaMCountDataReportAll($aDataCountData);
