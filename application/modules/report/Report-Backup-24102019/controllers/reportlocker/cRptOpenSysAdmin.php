...
class cRptOpenSysAdmin extends MX_Controller {
    ...
    private function init() {
        $this->aText = [
            'tTitleReport' => language('report/report/report', 'tRptTitleRptOpenSysAdmin'),
    ...
    public function index() {
        ...
        if (!empty($this->tRptExportType) && !empty($this->tRptCode)) {
            ...
            $this->mRptOpenSysAdmin->FSnMExecStoreReport($this->aRptFilter);
    ...
    public function FSvCCallRptViewBeforePrint($paDataSwitchCase) {
        ...
        // Get Data Report
        $aDataReport = $this->mRptOpenSysAdmin->FSaMGetDataReport($aDataWhere, $this->aRptFilter);
    ...
    public function FCNvCRenderKoolReportHtml($paDataReport, $paDataFilter) {
        ...
        require_once APPPATH . 'modules\report\datasources\rptRptOpenSysAdmin\rRptOpenSysAdmin.php';

        // Set Parameter To Report
        $oRptOpenSysAdminHtml = new rRptOpenSysAdmin(array(
        ...
        $oRptOpenSysAdminHtml->run();
        $tHtmlViewReport = $oRptOpenSysAdminHtml->render('wRptOpenSysAdminHtml', true);
    ...
    public function FSvCCallRptViewBeforePrintClickPage() {
        ...
        $aDataReport = $this->mRptOpenSysAdmin->FSaMGetDataReport($aDataWhere);
    ...
    public function FSvCCallRptRenderExcel($paDataSwitchCase) {
        ...
        try {
            ...
            $aDataTextRef = array(
                ...
                'tRptReason' => language('report/report/report', 'tRptReason'),
                'tRptUsrOpen' => language('report/report/report', 'tRptUsrOpen'),
                'tRptOpenSysAdmin' => language('common/main/main', 'tCMNNotFoundData'),
                // Address Lang
                'tRptAddrBuilding' => language('report/report/report', 'tRptAddrBuilding'),
                'tRptAddrRoad' => language('report/report/report', 'tRptAddrRoad'),
                'tRptAddrSoi' => language('report/report/report', 'tRptAddrSoi'),
            ...
            $aDataReport = $this->mRptOpenSysAdmin->FSaMGetDataReport($aDataWhere); //Get Data
            ...
            $objPHPExcel->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('B' . $nStartRowHeadder, $aDataTextRef['tRptDateOpen'])
                    ->setCellValue('C' . $nStartRowHeadder, $aDataTextRef['tRptChannelGrp'])
                    ->setCellValue('D' . $nStartRowHeadder, $aDataTextRef['tRptNoChannel'])
                    ->setCellValue('E' . $nStartRowHeadder, $aDataTextRef['tRptReason'])
                    ->setCellValue('F' . $nStartRowHeadder, $aDataTextRef['tRptUsrOpen']);
            ...
            if ($aDataReport['rtCode'] == 1) {
                ...
                foreach ($aDataReport['raItems'] as $nKey => $aValue) {
                    ...
                    $objPHPExcel->setActiveSheetIndex(0)
                            ...
                            ->setCellValue('E' . $nStartRowData, $aValue['rtHisRsnName'])
                            ->setCellValue('F' . $nStartRowData, $aValue['rtCreateName']);
                ...
                $objPHPExcel->setActiveSheetIndex(0)->setCellValue('A' . $nStartRowData, $aDataTextRef['tRptOpenSysAdmin']);
    ...
    public function FSoCChkDataReportInTableTemp($paDataSwitchCase) {
        ...
        try {
            ...
            $nDataCountPage = $this->mRptOpenSysAdmin->FSaMCountDataReportAll($aDataCountData);
