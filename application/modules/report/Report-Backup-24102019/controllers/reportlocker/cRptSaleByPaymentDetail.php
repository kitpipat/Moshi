...
class cRptSaleByPaymentDetail extends MX_Controller {
    ...
    private function init() {
        $this->aText = [
            ...
            'tRptSaleByPaymentDetailDateAndLocker' => language('report/report/report', 'tRptSaleByPaymentDetailDateAndLocker'),
            'tRptSaleByPaymentDetailPayTypeAndDocRef' => language('report/report/report', 'tRptSaleByPaymentDetailPayTypeAndDocRef'),
            ...
            // No Data Report
            'tRptSaleByPaymentDetailNoData' => language('common/main/main', 'tCMNNotFoundData'),
            ...
            // Text Label
            'tRptSaleByPaymentDetailTel' => language('report/report/report', 'tRptSaleByPaymentDetailTel'),
            'tRptSaleByPaymentDetailFax' => language('report/report/report', 'tRptSaleByPaymentDetailFax'),
            'tRptSaleByPaymentDetailDatePrint' => language('report/report/report', 'tRptSaleByPaymentDetailDatePrint'),
            'tRptSaleByPaymentDetailTimePrint' => language('report/report/report', 'tRptSaleByPaymentDetailTimePrint'),
            'tRptSaleByPaymentDetailBch' => language('report/report/report', 'tRptSaleByPaymentDetailBch'),
    ...
    public function index() {
        ...
        if (!empty($this->tRptCode) && !empty($this->tRptExportType)) {
            ...
            $this->mRptSaleByPaymentDetail->FSnMExecStoreReport($this->aRptFilter);
            ...
            $this->nRows = $this->mRptSaleByPaymentDetail->FSnMCountRowInTemp($aCountRowParams);
    ...
    public function FSvCCallRptViewBeforePrint() {
        try {
            ...
            $aDataReport = $this->mRptSaleByPaymentDetail->FSaMGetDataReport($aDataReportParams);
            /*===== End Get Data =======================================================*/
    ...
    public function FSvCCallRptRenderExcel() {
        ...
        $aDataReport = $this->mRptSaleByPaymentDetail->FSaMGetDataReport($aGetDataReportParams);
        /** =========== End Get Data ========================================= */
        try {
    ...
    public function FSoCChkDataReportInTableTemp() {
        try {
            ...
            $nDataCountPage = $this->mRptSaleByPaymentDetail->FSnMCountRowInTemp($aCountRowInTempParams);
