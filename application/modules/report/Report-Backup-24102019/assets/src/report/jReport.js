...
function JCNxRptSetMsgDataModalPrograss(poRptDataConfig){
    ...
    setTimeout(function(){
        ...
        var nConvertSetVakue    = parseInt(poRptDataConfig.nRptProgress);
...
function JCNxRptSubscribeExport(paDataSubscribe){
    ...
    */
    ...
    let tQueueNameSubscribe = 'RESRPT_'+tRptCode+'_'+tUserCode+'_'+tUserSessionID+'_'+dDateSubscribe+'_'+dTimeSubscribe;
