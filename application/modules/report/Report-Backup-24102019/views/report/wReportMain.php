...
<?php if(isset($aDataRptMenu) && $aDataRptMenu['rtCode'] == 1): ?>
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-5 col-lg-5">
            <?php $tMnuGrpCode  = ""; ?>
            <?php //echo '<pre>'; var_dump($aDataRptMenu['raItems']); echo '</pre>'; ?>
            <?php foreach($aDataRptMenu['raItems'] AS $nKey1 => $aRptValue1):?>
                <?php if($tMnuGrpCode != $aRptValue1['FTRptGrpCode']):?>
                    ...
                    <div class="panel panel-default" style="margin-bottom: 25px;">
                        <div id="odvHead<?php echo $aRptValue1['FTRptGrpCode'];?>" class="panel-heading xCNPanelHeadColor xWPanelHeadMenuRpt" role="tab">
                        ...
                        <div id="odvRptData<?php echo $aRptValue1['FTRptGrpCode'];?>" class="panel-collapse <?php echo $tContentCollapse;?>" role="tabpanel" aria-expanded="<?php echo $tExpandedChk;?>">
                            <div class="panel-body xCNPDModlue" style="padding:7px;">
                                <div class="table-responsive">
                                    <table id="otbRpt<?php echo $aRptValue1['FTRptGrpCode'];?>" class="table table-striped xCNTableRpt<?php echo $tFirstRowData;?>" style="margin:0;">
                                        <tbody>
                                            <?php $tMnuRptCode  = ""; ?>
                                            <?php $tMnuRptSeq   = 1; ?>
