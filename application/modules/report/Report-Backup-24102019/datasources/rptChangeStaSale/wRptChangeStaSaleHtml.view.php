        ...
        <div class="xCNContentReport">
            <div id="odvTableKoolReport" class="table-responsive">
                <?php if (isset($aDataReport['rtCode']) && !empty($aDataReport['rtCode']) && $aDataReport['rtCode'] == '1') { ?>
                    <?php
                    Table::create(array(
                        "dataSource" => $this->dataStore("RptChangeStaSale"),
                        "cssClass" => array(
                            "table" => "table",
                        ),
                        "headers" => array(
                            array(
                                ...
                                $aDataTextRef['tRptUSerChange'] => array(
                                    "style" => "text-align:left",
                                    "colSpan" => 1
                                ),
                            )
                ...
                <?php }else { ?>
                    <table class="table">
                        <thead>
                            ...
                            <th nowrap  class="text-center" style="width:10%"><?php echo $aDataTextRef['tRptUSerChange']; ?></th>
                        </thead>
                        <tbody>
