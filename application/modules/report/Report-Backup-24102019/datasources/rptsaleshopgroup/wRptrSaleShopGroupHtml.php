        ...
        <div class="xCNContentReport">
            <div id="odvRptTableAdvance" class="table-responsive">
                <table class="table">
                    <thead>
                    <tr>
                        <th nowrap class="text-left xCNTextBold" style="width:15%;  padding: 15px;"><?php echo  language('report/report/report','tRowNumber');?></th>
                        <th nowrap class="text-left xCNTextBold" style="width:15%; padding: 10px;"><?php echo  language('report/report/report','tRptTaxSaleLockerDocDate');?></th>
                        <th nowrap class="text-left xCNTextBold" style="width:15%; padding: 10px;"><?php echo  language('report/report/report','tRptXshDocNo');?></th>
                        <th nowrap class="text-left xCNTextBold" style="width:15%; padding: 10px;"><?php echo  language('report/report/report','tRptTaxSaleLockerDocRef');?></th>
                        <th nowrap class="text-left xCNTextBold" style="width:5%;  padding: 10px;"><?php  echo  language('report/report/report','tRptTaxSaleLockerCustomer');?></th>
                        <th nowrap class="text-left xCNTextBold" style="width:5%;  padding: 10px;"><?php  echo  language('report/report/report','tRptTaxNo');?></th>
                        <th nowrap class="text-left xCNTextBold" style="width:5%;  padding: 10px;"><?php  echo  language('report/report/report','tRptCstBussiness');?></th>
                        <th nowrap class="text-right xCNTextBold" style="width:5%;  padding: 10px;"><?php  echo  language('report/report/report','tRptTaxSaleLockerAmt');?></th>
                        <th nowrap class="text-right xCNTextBold" style="width:5%;  padding: 10px;"><?php  echo  language('report/report/report','tRptTaxSaleLockerAmtV');?></th>
                        <th nowrap class="text-right xCNTextBold" style="width:5%;  padding: 10px;"><?php  echo  language('report/report/report','tRptTaxSaleLockerAmtNV');?></th>
                        <th nowrap class="text-right xCNTextBold" style="width:5%;  padding: 10px;"><?php  echo  language('report/report/report','tRptTaxSaleLockerGrandTotal');?></th>
                    </tr>
                    </thead>
                    <tbody>
