            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    <?php if(isset($aCompanyInfo) && !empty($aCompanyInfo)):?>
                        ...
                        <?php endif;?>
                        <div class="text-left">
                            <label class="xCNRptLabel"><?php echo @$aDataTextRef['tRptTaxSalePosTel'] . @$aCompanyInfo['FTCmpTel']?> <?php echo @$aDataTextRef['tRptTaxSalePosFax'] . @$aCompanyInfo['FTCmpFax'];?></label>
                        </div>
                        <div class="text-left">
                            <label class="xCNRptLabel"><?php echo @$aDataTextRef['tRptTaxSalePosBch'] . @$aCompanyInfo['FTBchName'];?></label>
                        </div>
                    <?php endif;?>
                </div>
