        ...
        <div class="xCNContentReport">
            <div id="odvRptTableAdvance" class="table-responsive">
                <table class="table">
                    <thead>
                        <tr>
                            <th nowrap class="text-left xCNTextBold" style="width:5%;  padding: 15px;"><?php echo language('report/report/report', 'tRptPayby'); ?></th>
                    ...
                    <tbody>
                        <?php if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) { ?>
                            ...
                            <?php foreach ($aDataReport['aRptData'] as $nKey => $aValue): ?>
                                ...
                                $aSumFooter = array('รวม' . $aValue["FTRcvName"], 'N', 'N', $nSubSumFCXrcNet);
                                ...
                                $paFooterSumData = array('รวมทั้งสิ้น', 'N', 'N', $nSumFooterFCXrcNet);
                                ?>
                            <?php endforeach; ?>
                            <?php
