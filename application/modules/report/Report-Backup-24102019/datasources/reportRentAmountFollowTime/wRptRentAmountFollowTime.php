        ...
        <div class="xCNContentReport">
            <div id="odvRptTableAdvance" class="table-responsive">
                <table class="table">
                    <thead>
                        <tr>
                            <th nowrap class="text-left"><?php echo $aDataTextRef['tRptRentAmountFollowTimeSerailPos']; ?></th>
                            <th nowrap class="text-left"><?php echo $aDataTextRef['tRptRentAmtForFollowTimeTime']; ?></th>
                            <th nowrap class="text-right"><?php echo $aDataTextRef['tRptRentAmtForFollowTimeNumBill']; ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php if (isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) { ?>
                            ...
                            <?php for ($nI = 0; $nI < count($aSumData); $nI++) { ?>
                                ...
                                <?php for ($nFirst = 0; $nFirst < count($aDataTimeRef); $nFirst++) { ?>
                                    ...
                                    <tr>
                                        <?php if ($nFirst == 0) { ?>
                                            <td nowrap class="text-left" rowspan="<?php echo count($aDataTimeRef); ?>">
                                        ...
                                        <?php for ($nSecond = 0; $nSecond < count($aInforTB); $nSecond++) { ?>
                                            ...
                                            <?php if ($aSumData[$nI]["FTPosCode"] == $aInforTB[$nSecond]["FTPosCode"] && $aDataTimeRef[$nFirst] == $aInforTB[$nSecond]["FTBlockTime"]) { ?>
                                                ...
                                                <td nowrap class="text-left" style="width:20%">
                                                    <?php echo $aInforTB[$nSecond]["FTBlockTime"]; ?>
                                                </td>
                                                <td nowrap class="text-right" style="width:20%">
                                ...
                                <tr>
                                    <td nowrap colspan="2" class="text-left" style="border-top:1px solid #333 !important;border-bottom:1px solid #333 !important;background-color: #CFE2F3; ;padding: 4px;">
