        ...
        <div class="xCNContentReport">
            <div id="odvRptTableAdvance" class="table-responsive">
                <table class="table">
                    <thead>
                        <tr>
                            <th nowrap class="text-left"><?php echo $aDataTextRef['tRptTaxSalePosSeq'];?></th>
                            <th nowrap class="text-left"><?php echo $aDataTextRef['tRptTaxSalePosDocDate'];?></th>
                            <th nowrap class="text-left"><?php echo $aDataTextRef['tRptTaxSalePosDocNo'];?></th>
                            <th nowrap class="text-left"><?php echo $aDataTextRef['tRptTaxSalePosDocRef'];?></th>
                            <th nowrap class="text-left"><?php echo $aDataTextRef['tRptTaxSalePosCst'];?></th>
                            <th nowrap class="text-left"><?php echo $aDataTextRef['tRptTaxSalePosTaxID'];?></th>
                            <th nowrap class="text-left"><?php echo $aDataTextRef['tRptTaxSalePosComp'];?></th>
                            <th nowrap class="text-right"><?php echo $aDataTextRef['tRptTaxSalePosAmt'];?></th>
                            <th nowrap class="text-right"><?php echo $aDataTextRef['tRptTaxSalePosAmtV'];?></th>
                            <th nowrap class="text-right"><?php echo $aDataTextRef['tRptTaxSalePosAmtNV'];?></th>
                            <th nowrap class="text-right"><?php echo $aDataTextRef['tRptTaxSalePosTotal'];?></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <?php if(isset($aDataReport['aRptData']) && !empty($aDataReport['aRptData'])) { ?>  
                            ...
                            <?php foreach ($aDataReport['aRptData'] as $nKey => $aValue) { ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left"><?php echo date("d/m/Y", strtotime($aValue['FDXshDocDate'])); ?></td>
                                ...
                                <?php
                                    ...
                                    $paFooterSumData = array($aDataTextRef['tRptTaxSalePosTotalFooter'], 'N', 'N', 'N', 'N', 'N', 'N', number_format(@$aValue['FCXshAmt_Footer'], $nOptDecimalShow), number_format(@$aValue['FCXshAmtV_Footer'], $nOptDecimalShow), number_format(@$aValue['FCXshAmtNV_Footer'], $nOptDecimalShow), number_format(@$aValue['FCXshGrandTotal_Footer'], $nOptDecimalShow));
                                ?>
                            <?php } ?>
                            <?php
