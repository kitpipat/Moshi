             ...
             <table  class="table xWPdtTableFont">
                    ...
                    <tbody id="otbConditionRedeemHDGrp">
                        ...
                        <tr class="otrConditionRedeemCDGROUP" id='otrGrpRowID_<?=$nKey?>'>
                            ...
                            <td><input type='text' class='form-control xCNInputNumericWithDecimal  text-right'  name='oetRdcUsePoint[]' value='<?=$aData['FCRdcUsePoint']?>' ></td>
                            <td><input type='text' class='form-control xCNInputNumericWithDecimal xCNInputMaskCurrencyRdh  text-right'  name='oetRdcUseMny[]'  value='<?=$aData['FCRdcUseMny']?>' ></td>
                            <td><input type='text' class='form-control xCNInputNumericWithDecimal xCNInputMaskCurrencyRdh  text-right'  name='oetRdcMinTotBill[]' value='<?=$aData['FCRdcMinTotBill']?>' ></td>
