                        ...
                        <div class="col-md-12">
                            ...
                            <br>
                                    ...
                                    <table  class="table xWPdtTableFont">
                                        ...
                                        if($tRDHRoute == "dcmRDHEventAdd" && !empty($this->session->userdata('tSesUsrBchCode'))){
                                            $aRdhStaTypeName = array(1=>language('document/conditionredeem/conditionredeem','tRdhGroupConditionRedeemTypeInclude') , 2=>language('document/conditionredeem/conditionredeem','tRdhGroupConditionRedeemTypeExclude'));
                                            ?>
                                            ...
                                            <td>
                                            <input type='hidden' name='ohdRddConditionRedeemBchCode[0]' class='ohdRddConditionRedeemBchCode' tRddBchName='<?=$this->session->userdata('tSesUsrBchName')?>' value='<?=$this->session->userdata('tSesUsrBchCode')?>'>
                                            ...
                                            <?=$this->session->userdata('tSesUsrBchName')?></td>
