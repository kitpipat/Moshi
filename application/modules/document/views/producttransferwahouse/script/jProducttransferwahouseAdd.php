...
?>
	...
	$(document).ready(function() {
		...
		//ครวจสอบค่าของ SesUsrWahName
		// if(tSesUsrWahName != '' && tRoute == 'TFWEventAdd'){
		// // if(tSesUsrWahName != ""){
		// 	$('#oetWahNameStart').val(tSesUsrWahName);
		// }
...
$('#oimBrowseBch').click(function(){
        // Create By Saharat  31/03/2019
		JSxCheckPinMenuClose('oimBrowseBch');
    ...
    //     CallBack:{
    //         ReturnType	: 'S',
    //         Value		: ["oetHQBchCode","TCNMBranch.FTBchCode"],
    //         Text		: ["oetHQBchName","TCNMBranch_L.FTBchName"],
    //     },
	// 	// DebugSQL : true,
    //     RouteAddNew : 'branch',
	// 	BrowseLev : 0
