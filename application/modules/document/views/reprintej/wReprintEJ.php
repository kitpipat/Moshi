        ...
        <div class="row xCNavRow" style="width:inherit;">
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                <ol id="oliEJMenuNav" class="breadcrumb">
                    <li id="oliEJTitle" style="cursor:pointer;"><?php echo language('document/reprintej/reprintej', 'tEJTitleMenu'); ?></li>
                </ol>
            </div>
...
<script type="text/javascript" src="<?php echo base_url();?>application/modules/document/assets/src/reprintej/jReprintEJ.js"></script>