    ...
    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
        <div class="panel panel-default">
            <div id="odvEJConditionPanel" class="panel-heading xCNPanelHeadColor">
                <label class="xCNTextDetail1"><?php echo language('document/reprintej/reprintej','tEJPanelCondition');?></label>
            </div>
                ...
                <div class="panel-body">
                    <form action="javascript:void(0);" id="ofmEJConditionFilter">                        
                        ...
                        <div id="odvEJFilterBranchAndShop" class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="xWEJBoxFilter">
                                    <label class="xCNLabelFrm xWEJLabelFilter"><?php echo language('document/reprintej/reprintej','tEJFilterBranch');?></label>
                                    <div class="form-group">
                                        <?php
                                            ...
                                            if($this->session->userdata("tSesUsrLevel") == "BCH" || $this->session->userdata("tSesUsrLevel") == "SHP"){
                                                ...
                                                $tCheckBchName  = $this->session->userdata('tSesUsrBchName');
                                        ...
                                        <div class="input-group">
                                            <input type='text' class='form-control xCNHide' id='oetEJBchCode' name='oetEJBchCode' maxlength='5' value="<?php echo @$tCheckBchCode;?>">
                                            <input
                                                type='text'
                                                class='form-control xWPointerEventNone'
                                                id='oetEJBchName'
                                                name='oetEJBchName'
                                                value="<?php echo @$tCheckBchName;?>"
                                                placeholder="<?php echo language('document/reprintej/reprintej','tEJPacFilterBranch');?>"
                                                readonly
                                            >
                                            <span class='input-group-btn'>
                                                <button id='obtEJBrowseBranch' type='button' class='btn xCNBtnBrowseAddOn'<?php echo @$tEJDisableBrowseBranch;?>>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input
                                                ...
                                                placeholder="<?php echo language('document/reprintej/reprintej','tEJPacFilterShop');?>"
                                                readonly
                                            >
                                            <span class='input-group-btn'>
                        ...
                        <div id="odvEJFilterDocDate" class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="xWEJBoxFilter">
                                    <label class="xCNLabelFrm xWEJLabelFilter"><?php echo language('document/reprintej/reprintej','tEJFilterDate');?></label>
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                            <div class="form-group">
                                                <label class='xCNLabelFrm'><?php echo language('document/reprintej/reprintej','tEJFilterDateFrom');?></label>
                                                <div class='input-group'>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                            <div class="form-group">
                                                <label class='xCNLabelFrm'><?php echo language('document/reprintej/reprintej','tEJFilterDateTo');?></label>
                                                <div class='input-group'>
                        ...
                        <div id="odvEJFilterDocumentNo" class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="xWEJBoxFilter">
                                    <label class="xCNLabelFrm xWEJLabelFilter"><?php echo language('document/reprintej/reprintej','tEJFilterDocument');?></label>
                                    <div class="form-group">
                                        <label class="fancy-checkbox p-b-5">
                                            <input type="checkbox" id="ocbEJShipCodeUse"  name="ocbEJShipCodeUse">
                                            <span><?php echo language('document/reprintej/reprintej','tEJFilterShipCodeUse');?></span>
                                        </label>
                                        <div class='input-group'>
                                    ...
                                    <div class="form-group">
                                        <label class="fancy-checkbox p-b-5">
                                            <input type="checkbox" id="ocbEJShipBetween"  name="ocbEJShipBetween">
                                            <span><?php echo language('document/reprintej/reprintej','tEJFilterSlipBetween');?></span>
                                        </label>
                                        <div class="form-group">
                                            <label class='xCNLabelFrm'><?php echo language('document/reprintej/reprintej','tEJFilterSlipCodeFrom');?></label>
                                            <div class='input-group'>
                                                ...
                                                <input
                                                    ...
                                                    placeholder="<?php echo language('document/reprintej/reprintej','tEJFilterSlipCodeFrom');?>"
                                                    readonly
                                                >
                                                <span class='input-group-btn'>
                                        ...
                                        <div class="form-group">
                                            <label class='xCNLabelFrm'><?php echo language('document/reprintej/reprintej','tEJFilterSlipCodeTo');?></label>
                                            <div class='input-group'>
                                                ...
                                                <input
                                                    ...
                                                    placeholder="<?php echo language('document/reprintej/reprintej','tEJFilterSlipCodeTo');?>"
                                                    readonly
                                                >
                                                <span class='input-group-btn'>
                        ...
                        <div id="odvEJFilterDocumentNo" class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="xWEJBoxFilter">
                                    <label class="xCNLabelFrm xWEJLabelFilter"><?php echo language('document/reprintej/reprintej','tEJFilterDocumentType');?></label>
                                    <div class="form-group">
                                        <select class="form-control selectpicker" id="ocmEjDocumentType" name="ocmEjDocumentType">
                                            <option value="1"><?php echo language('document/reprintej/reprintej','tEJDocumentTypeXAll');?></option>
                                            <option value="2"><?php echo language('document/reprintej/reprintej','tEJDocumentTypeXSale');?></option>
                                            <option value="3"><?php echo language('document/reprintej/reprintej','tEJDocumentTypeXPay');?></option>
                                            <option value="4"><?php echo language('document/reprintej/reprintej','tEJDocumentTypeXRoundOff');?></option>
                                            <option value="5"><?php echo language('document/reprintej/reprintej','tEJDocumentTypeXRecive');?></option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="odvBtnReprintEJFilter" class="row p-t-20">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 p-b-10">
                            <button type="button" id="obtRPEJRefreshView" class="btn btn-primary" style="font-size: 17px;width: 100%;">
                                <?php echo language('document/reprintej/reprintej','tRPEJRefreshView') ?>
                            </button>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 p-b-10">
                            <button type="button" id="obtRPEJFilterSerch" class="btn btn-primary" style="font-size: 17px;width: 100%;">
                                <?php echo language('document/reprintej/reprintej','tRPEJFilterSerch') ?>
                            </button>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-8">
        <div class="panel panel-default" style="margin-bottom: 25px;">
            <div id="odvEJAbbrViewer" class="panel-heading xCNPanelHeadColor">
                <label class="xCNTextDetail1"><?php echo language('document/reprintej/reprintej','tEJPanelAbbrViewer');?></label>
            </div>
