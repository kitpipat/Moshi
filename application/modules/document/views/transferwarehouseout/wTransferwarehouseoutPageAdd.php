...
<?php
    ...
    if(isset($aDataDocHD) && $aDataDocHD['rtCode'] == "1"){ 
        ...
        $tTWORsnName            = $aDataDocHDRef['raItems']['FTXthCtrName'];
        ...
        $tTWOVATInOrEx          = 1;
        $tTWOMerCode            = "";
        $tTWOShopFrm            = $this->session->userdata ("tSesUsrShpCode");
        $tTWOShopTo             = $this->session->userdata ("tSesUsrShpCode");
        $tTWOShopName           = $this->session->userdata ("tSesUsrShpName");
        $tTWOShopNameTo         = $this->session->userdata ("tSesUsrShpName");
        $tTWOWhFrm              = "";
        $tTWOWhTo               = "";
        $tTWOWhName             = "";
        $tTWOWhNameTo           = "";
...
<form id="ofmTransferwarehouseoutFormAdd" class="validate-form" action="javascript:void(0)" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" id="ohdTWOSesUsrBchCode"       name="ohdTWOSesUsrBchCode"          value="<?=$this->session->userdata("tSesUsrBchCode");?>">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div class="form-group" style="cursor:not-allowed">
                                    <input 
                                        type="text"
                                        class="form-control xWTooltipsBT xCNInputWOthoutSpcNotThai xCNInputWOthoutSingleQuote"
                                        id="oetTWODocNo"
                                        name="oetTWODocNo"
                                        maxlength="20"
                                        value="<?=$tTWODocNo;?>"
                                        data-validate-required="<?=language('document/transferwarehouseout/transferwarehouseout', 'tTWOPlsEnterOrRunDocNo'); ?>"
                                        data-validate-duplicate="<?=language('document/transferwarehouseout/transferwarehouseout', 'tTWOPlsDocNoDuplicate'); ?>"
                                        placeholder="<?=language('document/transferwarehouseout/transferwarehouseout','tTWODocNo');?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input
                                            ...
                                            name="oetTWODocDate"
                                            value="<?=$dTWODocDate;?>"
                                            data-validate-required="<?=language('document/transferwarehouseout/transferwarehouseout', 'tASTPlsEnterDocDate');?>"
                                        >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input
                                            ...
                                            name="oetTWODocTime"
                                            value="<?=$dTWODocTime;?>"
                                            data-validate-required="<?=language('document/transferwarehouseout/transferwarehouseout', 'tTWOPlsEnterDocTime');?>"
                                        >
                                        <span class="input-group-btn">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <?php
                                    if($tTWORoute == "dcmTWOEventAdd"){
                                        if($tSesUsrLevel == "HQ"){
                                            $tTWODataInputBchCode    = $tTWOBchCompCode;
                                            $tTWODataInputBchName    = $tTWOBchCompName;
                                        }else{
                                            $tTWODataInputBchCode    = $tTWOUserBchCode;
                                            $tTWODataInputBchName    = $tTWOUserBchName;
                                        }
                                    }else{
                                ...
                                ?>
                                <!-- <input class="form-control xCNHide" id="oetSOFrmBchCode" name="oetSOFrmBchCode" maxlength="5" value="<?=$tTWODataInputBchCode;?>">
                                <label class="xCNLabelFrm"><?=language('document/saleorder/saleorder', 'tSOLabelFrmBranch');?></label>
                                <label>&nbsp;<?=$tTWODataInputBchName;?></label> -->
                                ...
                                <label class="xCNLabelFrm"><?php echo language('document/saleorder/saleorder', 'tSOLabelFrmBranch')?></label>
                                    <div class="input-group">
                                        <input
                                            ...
                                            maxlength="5"
                                            value="<?php echo $tTWODataInputBchCode;?>"
                                        >
                                        <input
                                            type="text"
                                            ...
                                            value="<?php echo $tTWODataInputBchName;?>"
                                            readonly
                                        >
                                        <span class="input-group-btn">
                                    ...
                                    <div class="col-lg-12">
                                        <fieldset class="scheduler-border">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input name="oetTROutShpFromName" id="oetTROutShpFromName" class="form-control " value="<?=$tTWOShopName?>" type="text" readonly="" 
                                                    ...
                                                    <span class="input-group-btn">
                                                        <button class="btn xCNBtnBrowseAddOn xCNApvOrCanCelDisabled"
                                                        <?php 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input name="oetTROutWahFromName" id="oetTROutWahFromName" class="form-control" value="<?=$tTWOWhName?>" type="text" readonly="" 
                                                            placeholder="<?= language('document/transferwarehouseout/transferwarehouseout', 'tTWOWahhouse') ?>" >
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div id="odvDocType_4">
                                            ...
                                            <div class="form-group">
                                                <label class="xCNLabelFrm"><?= language('document/topupVending/topupVending', 'tShop'); ?></label>
                                                <div class="input-group">
                                                    <input name="oetTROutShpToName" id="oetTROutShpToName" class="form-control " value="<?=$tTWOShopNameTo?>" type="text" readonly="" 
                                                            placeholder="<?= language('document/topupVending/topupVending', 'tShop') ?>">
                                            ...
                                            <div class="form-group">
                                                <label class="xCNLabelFrm"><span style="color:red">*</span><?= language('document/transferwarehouseout/transferwarehouseout', 'tTWOWahhouse'); ?></label>
                                                <div class="input-group">
                                                    <input name="oetTROutWahToName" id="oetTROutWahToName" class="form-control " value="<?=$tTWOWhNameTo?>" type="text" readonly="" 
                                                            placeholder="<?= language('document/transferwarehouseout/transferwarehouseout', 'tTWOWahhouse') ?>" >
                                                    ...
                                                    <span class="input-group-btn">
                                                        ...
                                                        ?>
                                                         id="obtBrowseTROutToWah" type="button">
                                                            <img src="<?= base_url() . '/application/modules/common/assets/images/icons/find-24.png' ?>">
                                                        </button>
                                                    </span>
                                                </div>
                            ...
                            <!--ประเภทของการรับเข้า-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input name="oetTRINSplName" id="oetTRINSplName" class="form-control " value="<?=$tTWOSplName?>" type="text" readonly="" 
                                                    placeholder="<?= language('document/topupVending/topupVending', 'tTBSpl') ?>">
                                    ...
                                    <div class="form-group">
                                        <label class="xCNLabelFrm"><?= language('document/topupVending/topupVending', 'tShop'); ?></label>
                                        <div class="input-group">
                                            <input name="oetTRINShpName" id="oetTRINShpName" class="form-control " value="<?=$tTWOShopNameTo?>" type="text" readonly="" 
                                                    placeholder="<?= language('document/topupVending/topupVending', 'tShop') ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input
                                    ...
                                    id="oetTWORefIntDocDate"
                                    name="oetTWORefIntDocDate"
                                    placeholder="YYYY-MM-DD"
                                    value="<?=$tTWORefIntDate?>"
                                >
                                <span class="input-group-btn">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input
                                    type="text"
                                    class="form-control xCNDatePicker xCNInputMaskDate xCNApvOrCanCelDisabled"
                                    id="oetTWORefExtDocDate"
                                    name="oetTWORefExtDocDate"
                                    placeholder="YYYY-MM-DD"
                                    value="<?=$tTWORefExtDate?>"
                                >
                                <span class="input-group-btn">
                ...
                <div id="odvTWODataConditionTransport" class="xCNMenuPanelData panel-collapse collapse" role="tabpanel">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control xCNInputWOthoutSpc xCNApvOrCanCelDisabled" maxlength="100" id="oetTWOTransportCtrName" name="oetTWOTransportCtrName" value="<?=$tTWORsnName?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <!-- <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="xCNLabelFrm"><?=language('document/transferwarehouseout/transferwarehouseout', 'tTWOTransportNumber'); ?></label>
                                    <input type="text" class="form-control xCNInputWOthoutSpc xCNApvOrCanCelDisabled" maxlength="100" id="oetTWTransportNumber" name="oetTWORefTransportNumber" value="<?=$tTWOViaCode?>">
                                </div>
                            </div>
                        </div> -->
                        <div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<div class="input-group">
										...
										id="oetTWOUpVendingViaCode" 
										name="oetTWOUpVendingViaCode" 
										value="<?php echo $tTWOViaCode ?>">
										<span class="input-group-btn">
                ...
                <div id="odvTWODataConditionETC" class="xCNMenuPanelData panel-collapse collapse" role="tabpanel">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input name="oetTWOReasonName" id="oetTWOReasonName" class="form-control" value="<?=$tTWORsnName?>" type="text" readonly="" 
                                        placeholder="<?= language('document/transferwarehouseout/transferwarehouseout', 'tTWOReason') ?>">
                        ...
                        <div class="form-group">
                            ...
                            <textarea
                                class="form-control xCNApvOrCanCelDisabled"
                                id="otaTWOFrmInfoOthRmk"
                                name="otaTWOFrmInfoOthRmk"
                                rows="10"
                                maxlength="200"
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                id="ocmTWOFrmInfoOthDocPrint"
                                name="ocmTWOFrmInfoOthDocPrint"
                                value="<?=$tTWODocPrint;?>"
                                readonly
                            >
                        </div>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input
                                                        ...
                                                        class="form-control"
                                                        maxlength="100"
                                                        id="oetTWOFrmFilterPdtHTML"
                                                        name="oetTWOFrmFilterPdtHTML"
                                                        placeholder="<?php echo language('document/transferwarehouseout/transferwarehouseout','tTWOFrmFilterTablePdt');?>"
                                                        onkeyup="javascript:if(event.keyCode==13) JSvTWODOCFilterPdtInTableTemp()"
                                                    >
                                                    <input 
                                                        type="text"
                                                        class="form-control"
                                                        maxlength="100"
                                                        id="oetTWOFrmSearchAndAddPdtHTML"
                                                        name="oetTWOFrmSearchAndAddPdtHTML"
                                                        onkeyup="Javascript:if(event.keyCode==13) JSxTWOChkConditionSearchAndAddPdt()"
                                                        placeholder="<?=language('document/transferwarehouseout/transferwarehouseout','tTWOFrmSearchAndAddPdt');?>"
                                                        style="display:none;"
                                                        data-validate="<?=language('document/transferwarehouseout/transferwarehouseout','tTWOMsgValidScanNotFoundBarCode');?>"
                                                    >
                                                    <span class="input-group-btn">
...
<div id="odvTWOModalAppoveDoc" class="modal fade">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
