<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        if(tUserBchCode != '' && tSesUsrLevel != "HQ"){
    ...
    // ===================================== เลือกประเภทต่างๆ =====================================
        ...
        $('#obtBrowseTROutFromShp').click(function(){ JCNxBrowseData('oBrowseTROutFromShp'); });
        ...
        var oBrowseTROutFromPos = {
            ...
            Where   : {
                Condition : [      " AND TVDMPosShop.FTBchCode = '"+$('#oetSOFrmBchCode').val()+"'  AND TVDMPosShop.FTShpCode = '" + $('#oetTROutShpFromCode').val() + "' "
                    + " AND TVDMPosShop.FTPosCode != '"+$('#oetTROutPosToCode').val()+"' "]
            },
            GrideView : {
        ...
        $('#obtBrowseTROutFromPos').click(function(){ JCNxBrowseData('oBrowseTROutFromPos'); });
        ...
        var oBrowseTROutFromWah_BCH = function(paDataparamiter){
            ...
            Where : {
                Condition : ["AND TCNMWaHouse.FTWahStaType IN (1,2,5) AND TCNMWaHouse.FTBchCode = '" + tBchCode + "' AND TCNMWaHouse.FTWahCode !='"+tWahCodeTo+"'"]
            },
            GrideView : {
                ColumnPathLang  : 'company/shop/shop',
                ColumnKeyLang   : ['tWahCode','tWahName'],
        ...
        $('#obtBrowseTROutToShp').click(function(){ JCNxBrowseData('oBrowseTROutToShp'); });
        ...
        var oBrowseTROutToPos = {
            ...
            Where       :   {
                Condition : [" AND TVDMPosShop.FTBchCode = '"+$('#oetSOFrmBchCode').val()+"'  AND TVDMPosShop.FTShpCode = '" + $('#oetTROutShpToCode').val() + "' "
                    + " AND TVDMPosShop.FTPosCode != '"+$('#oetTROutPosFromCode').val()+"' "]
            },
            GrideView   :   {
                ColumnPathLang	: 'pos/posshop/posshop',
        ...
        // $('#obtBrowseTROutToPos').attr('disabled',true);
        $('#obtBrowseTROutToPos').click(function(){ JCNxBrowseData('oBrowseTROutToPos'); });
        ...
        var oBrowseTROutToWah_BCH = function(paParam){
            ...
            Where : {
                Condition : ["AND TCNMWaHouse.FTWahStaType IN(1,2,5) AND TCNMWaHouse.FTBchCode = '" + tBchCode + "' AND TCNMWaHouse.FTWahCode != '"+tWahCodeFrom+"' "]
            },
            GrideView : {
                ColumnPathLang  : 'company/shop/shop',
                ColumnKeyLang   : ['tWahCode','tWahName'],
    ...
    ///////[เอกสารรับเข้า]
        ...
        $('#obtBrowseTWOReason').click(function(){ JCNxBrowseData('oBrowseTWOReason'); });
        ...
        $.ajax({
            ...
            success : function (oResult) {
                ...
                if(aDataReturn['nStaEvent'] == '1'){
                    ...
                    $('#odvTWOOrderAdvTblColumns').modal({backdrop: 'static', keyboard: false})  
                    $("#odvTWOOrderAdvTblColumns").modal({ show: true });
                }else{
                    var tMessageError = aReturnData['tStaMessg'];
                    FSvCMNSetMsgErrorDialog(tMessageError);
                    JCNxCloseLoading();
    ...
    function JSnTWORemovePdtDTTempSingle(ptSeqNo,ptPdtCode){
        ...
        var tTWOBchCode      = $('#ohdTWOBchCode').val();
        var tTWOVatInOrEx    = 1;
        JCNxOpenLoading();
        $.ajax({
            type    : "POST",
