<script type="text/javascript">
    ...
    var tUserBchCodeto    = '<?php echo $this->session->userdata("tSesUsrBchCode");?>';
    var tUserBchNameto  = '<?php echo $this->session->userdata("tSesUsrBchName");?>';
    ...
    $(document).ready(function(){
        ...
        if(tUserBchCode != ''){
            $('#oetTBIFrmBchCode').val(tUserBchCode);
    ...
    $("#obtSearchShipVia").click(function() {
        ...
        $('#odvTWOBrowseShipAdd #oliPIEditShipAddress').unbind().click(function(){
            ...
            if(typeof(nStaSession) !== 'undefined' && nStaSession == 1){
                var tTWOWhereCons    = "";
                if($("#oetTBIFrmBchCode").val() != ""){
                 
                            // Address Ref BCH
                            tTWOWhereCons        +=  "AND FTAddGrpType = 1 AND FTAddRefCode = '"+$("#oetTBIFrmBchCode").val()+"' AND TCNMAddress_L.FNLngID = "+nLangEdits;
        ...
        function JSvTWOGetShipAddrData(paInForCon){
         ...
         $('#obtTBIFrmBrowseShipAdd').unbind().click(function(){
            ...
            GrideView:{
                ...
                DisabledColumns     : [5],
                Perpage			    : 10,
                OrderBy			    : ['TCNTPdtIntDTBch.FDCreateOn ASC,TCNTPdtIntDTBch.FTXthDocNo ASC'],
            },
            CallBack: {
                ReturnType	: 'S',
    ...
    ///////[เอกสารรับโอน]
        ...
        $('#obtImportPDTInCN').click(function(){ 
            var tBCHCode = $('#oetTBIFrmBchCode').val();
    ...
    function JSnTBIRemovePdtDTTempSingle(ptSeqNo,ptPdtCode){
        ...
        var tTBIBchCode      = $('#ohdTBIBchCode').val();
        var tTBIVatInOrEx    = 1;
        JCNxOpenLoading();
        $.ajax({
            type    : "POST",
    ...
    var oBrowse_BCH = {
            ...
            CallBack:{
                ReturnType : 'S',
                Value  : ["oetTBIFrmBchCode","TCNMBranch.FTBchCode"],
                Text  : ["oetTBIFrmBchName","TCNMBranch_L.FTBchName"],
            },
            NextFunc    :   {
    ...
    $(document).ready(function(){
        ...
        // var tUsrBchCode = $("#ohdTBIBchCode").val();
