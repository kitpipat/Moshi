                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                >
                                <span class="input-group-btn">
                                    <button id="obtASTBrowseBchFrom" type="button" class="btn xCNBtnBrowseAddOn" <?php echo $tStaBlockBrowse; ?> ><img class="xCNIconFind"></button>
                                </span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                >
                                <span class="input-group-btn">
                                    <button id="obtASTBrowseBchTo" type="button" class="btn xCNBtnBrowseAddOn" <?php echo $tStaBlockBrowse; ?>><img class="xCNIconFind"></button>
                                </span>
                            </div>
                        </div>
                    </div>
