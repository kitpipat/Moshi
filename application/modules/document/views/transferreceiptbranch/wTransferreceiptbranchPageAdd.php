...
<?php
    ...
    if(isset($aDataDocHD) && $aDataDocHD['rtCode'] == "1"){ 
        ...
        $nTBIStaDocAct          = "";
        $tTBIStaDelMQ           = "";
        $tTBIBchCode            = $tBchCode;
        $tTBIBchName            = $tBchName;
        ...
        $tTBIBchCodeFrm         = "";
        $tTBIBchNameFrm         = "";
        $tTBIBchCodeTo          = $tBchCode;
        $tTBIBchNameTo          = $tBchName;
...
<form id="ofmTransferreceiptFormAdd" class="validate-form" action="javascript:void(0)" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" id="ohdTBIShpCode"             name="ohdTBIShpCode"                value="<?=$this->session->userdata("tSesUsrShpCode");?>">
...
<div id="odvTBIModalAppoveDoc" class="modal fade">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
