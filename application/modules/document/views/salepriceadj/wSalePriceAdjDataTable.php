            ...
            <table id="otbSpaDataList" class="table table-striped"> 
                <thead>
                    <tr>
                        ...
                        <th nowrap class="text-center xCNTextBold" style="width:15%;"><?php echo  language('document/salepriceadj/salepriceadj','tTBSpaDocNo')?></th>
                        ...
                        <th nowrap class="text-center xCNTextBold" style="width:10%;"><?php echo  language('document/salepriceadj/salepriceadj','tTBSpaStaDoc')?></th>
                        <th nowrap class="text-center xCNTextBold" style="width:10%;"><?php echo  language('document/salepriceadj/salepriceadj','tTBSpaXphUsrApv')?></th>
                        <th nowrap class="text-center xCNTextBold" style="width:10%;"><?php echo  language('document/salepriceadj/salepriceadj','tTBSpaStaPrcDoc')?></th>
                ...
                <tbody>
                    <?php if($aSpaDataList['rtCode'] == 1 ):?>
                        ...
                        ?>
                            ...
                            <tr class="text-center xCNTextDetail2 otrPdtSpa" id="otrPdtSpa<?php echo $nKey?>" data-doc="<?php echo $aValue['FTXphDocNo']?>" data-bch="<?php echo $aValue['FTBchCode']?>">
                                <?php if($aAlwEventSalePriceAdj['tAutStaFull'] == 1 || $aAlwEventSalePriceAdj['tAutStaDelete'] == 1) : ?>
                                ...
                                <td nowrap><?php echo date("d/m/Y",strtotime($aValue['FDXphDocDate']));?></td>
                                ...
                                <?php if($aAlwEventSalePriceAdj['tAutStaFull'] == 1 || $aAlwEventSalePriceAdj['tAutStaDelete'] == 1) : ?>
                                <td nowrap <?php if($aValue['FTXphStaApv']!="" || $aValue['FTXphStaDoc']=="3"){ echo "class='xWTdDisable'"; } ?>><img class="xCNIconTable <?php if($aValue['FTXphStaApv']!="" || $aValue['FTXphStaDoc']=="3"){ echo "xWImgDisable"; } ?>" src="<?php echo  base_url().'/application/modules/common/assets/images/icons/delete.png'?>" onClick="JSoSpaDel('<?php echo $nCurrentPage?>','<?php echo $aValue['FTXphDocNo']?>')" <?php if($aValue['FTXphStaApv']!="" || $aValue['FTXphStaDoc']=="3"){ echo "disabled"; } ?>></td>
                                <?php endif; ?>
                                <?php if($aAlwEventSalePriceAdj['tAutStaFull'] == 1 || ($aAlwEventSalePriceAdj['tAutStaEdit'] == 1 || $aAlwEventSalePriceAdj['tAutStaRead'] == 1)) : ?>
                                <td nowrap><img class="xCNIconTable" src="<?php echo  base_url().'/application/modules/common/assets/images/icons/edit.png'?>" onClick="JSvCallPageSpaEdit('<?php echo $aValue['FTXphDocNo']?>')"></td>
                                <?php endif; ?>
                            </tr>
                        <?php endforeach;?>
                    <?php else:?>
