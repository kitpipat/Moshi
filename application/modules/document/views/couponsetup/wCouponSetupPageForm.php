...
<form id="ofmCouponSetupAddEditForm" class="validate-form" action="javascript:void(0)" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" id="ohdCPHUsrBchCode"  name="ohdCPHUsrBchCode" value="<?php echo @$tCPHUsrBchCode;?>">
    <!-- Status Document -->
...
<div id="odvCPHModalAppoveDoc" class="modal fade">
