        ...
        <div class="row">
            <div class="table-responsive">
              ...
              <div  style="padding-bottom: 20px;">
                    <?php  if(empty($this->session->userdata('tSesUsrBchCode'))){ ?>
             ...
             <table  class="table xWPdtTableFont">
                    ...
                    <?php 
                            if($tCPHRoute == "dcmCouponSetupEventAdd" && !empty($this->session->userdata('tSesUsrBchCode'))){ 
                                ?>
                                <tr class='otrInclude' id='otrCPHcouponIncludeBch0'>
                                <td>
                                <input type='hidden' name='ohdCPHCouponIncludeBchCode[0]' class='ohdCPHCouponIncludeBchCode' value='<?=$this->session->userdata('tSesUsrBchCode')?>'>
                                ...
                                <td><?=$this->session->userdata('tSesUsrBchName')?></td>
...
$('#obtCPHBrowseBchTo').unbind().click(function(){
    ...
    $('#obtCPHBrowseShpTo').unbind().click(function(){
        ...
        if(typeof(nStaSession) !== 'undefined' && nStaSession == 1){
            ...
            let tCPHBranchForm  = $('#oetCPHBchCodeFrom').val();
 ...
 var oCPHShopOption = function(poReturnInputShp){
        ...
        if(typeof tCPHBranchForm === 'undefined'  && typeof tCPHBranchTo === 'undefined'){
            ...
            if(tCPHBranchForm == "" && tCPHBranchTo == ""){
                // แสดงข้อมูล ร้านค้าทั้งหมดตามประเภทของรายงาน
                var oShopOptionReturn   = {
                    Title   : ['company/shop/shop','tSHPTitle'],
                    Table   : {Master:'TCNMShop', PK:'FTShpCode'},
