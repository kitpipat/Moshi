            ...
            <table class="table table-striped">
                <thead>
                    <tr class="xCNCenter">
                        ...
                        <th class="xCNTextBold"><?= language('document/producttransferwahouse/producttransferwahouse','tTFWTBStaApv')?></th>
                ...
                <?php if($aDataList['rtCode'] == 1 ):?>
                    <?php foreach($aDataList['raItems'] AS $key=>$aValue){ ?>
                        ...
                        <tr class="text-center xCNTextDetail2 otrPurchaseoeder" id="otrPurchaseoeder<?=$key?>" data-code="<?=$aValue['FTXthDocNo']?>" data-name="<?=$aValue['FTXthDocNo']?>">
							...
							<td class="text-left"><label class="xCNTDTextStatus <?=$tClassStaDoc?>"><?php echo language('document/producttransferwahouse/producttransferwahouse','tTFWStaDoc'.$aValue['FTXthStaDoc']) ?></label></td>
							<td class="text-left"><label class="xCNTDTextStatus <?=$tClassStaApv?>"><?= language('document/producttransferwahouse/producttransferwahouse','tTFWStaApv'.$aValue['FTXthStaApv'])?></label></td>
                            ...
                            <td class="text-left"><?php if($aValue['FTXthApvCode']!=""){ echo $aValue['FTXthApvName']; }else{ ?> <?= language('document/producttransferwahouse/producttransferwahouse','tTFWNotFound')?> <?php } ?></td> 
							<?php if($aAlwEvent['tAutStaFull'] == 1 || $aAlwEvent['tAutStaDelete'] == 1) : ?>
                            	<td>
