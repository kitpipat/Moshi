            ...
            <div class="xCNTFWVMaster">
                <div class="col-xs-12 col-md-6">
                    <ol id="oliMenuNav" class="breadcrumb">
                        <li id="oliTFWTitle" class="xCNLinkClick" onclick="JSvCallPageTFWList()"><?= language('document/producttransferbrach/producttransferbrach', 'tTFWTitle') ?></li>
                        <li id="oliTFWTitleAdd" class="active"><a><?= language('document/producttransferbrach/producttransferbrach', 'tTFWTitleAdd') ?></a></li>
                        <li id="oliTFWTitleEdit" class="active"><a><?= language('document/producttransferbrach/producttransferbrach', 'tTFWTitleEdit') ?></a></li>
                    </ol>
                </div>
                        ...
                        <div id="odvBtnAddEdit">
                            <div class="demo-button xCNBtngroup" style="width:100%;">
                                ...
                                <?php if ($aAlwEvent['tAutStaFull'] == 1 || ($aAlwEvent['tAutStaAdd'] == 1 || $aAlwEvent['tAutStaEdit'] == 1)) : ?>
                                    <button id="obtTFBchPrint" onclick="JSxTFWBchPrintDoc()" class="btn xCNBTNDefult xCNBTNDefult2Btn" type="button"> <?php echo language('common/main/main', 'tCMNPrint') ?></button>
...
<script type="text/javascript" src="<?php echo base_url() ?>application/modules/document/assets/src/producttransferbrach/jProducttransferbrach.js"></script>
