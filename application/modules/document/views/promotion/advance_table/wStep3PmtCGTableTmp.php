    ...
    <table class="table table-striped xWPdtTableFont" id="otbPromotionStep3PmtCGTable">
        <thead>
            <tr>
                ...
                <th width="35%" class="text-left"><?php echo language('document/promotion/promotion', 'tGroupName'); ?></th>
                <th width="15%" class="text-center"><?php echo language('document/promotion/promotion', 'tGetConditions'); ?></th>
                <th width="15%" class="text-right"><?php echo language('document/promotion/promotion', 'tValue_Number'); ?></th>
                <th width="15%" class="text-right"><?php echo language('document/promotion/promotion', 'tAmountToReceive'); ?></th>
                <th width="15%" class="text-right"><?php echo language('document/promotion/promotion', 'tAveragePercentDiscount'); ?></th>
            </tr>
        </thead>
        <tbody>
                    ...
                    <tr class="xCNTextDetail2 xCNPromotionStep3PmtCGRow" data-seq-no="<?php echo $aValue['FNPgtSeq']; ?>">
                        ...
                        <td class="text-left">
                            ...
                            <?php }else{ ?>
                                ...
                                type="text"
                                class="text-right form-control xCNInputWithoutSpc xCNApvOrCanCelDisabledPmtCG xCNPromotionStep3PgtGetvalue xCNInputMaxValue xCNInputLength <?php echo $tNumberFormatControl; ?>"  
                                data-length="14"
                                maxlength="14"
                        ...
                        <td>
                            <input 
                            type="text" 
                            class="form-control text-right xCNPromotionPgtPerAvgDisCG xCNInputNumeric xCNInputWithoutSpc xCNApvOrCanCelDisabledPmtCG xCNInputMaxValue xCNInputLength"  
                            maxlength="5"
                            data-length="5" 
                            data-max="100"
