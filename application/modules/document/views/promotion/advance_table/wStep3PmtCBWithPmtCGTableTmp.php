    ...
    <table class="table table-striped xWPdtTableFont" id="otbPromotionStep3PmtCBWithPmtCGTable">
        <thead>
            <tr>
                ...
                <th nowrap width="15%" class="text-left"><?php echo language('document/promotion/promotion', 'tListGroupName'); ?></th>
                <th nowrap width="10%" class="text-center"><?php echo language('document/promotion/promotion', 'tBuyConditions'); ?></th>
                ...
                <?php if($tPbyStaBuyCond == "5" || $tPbyStaBuyCond == "6"){ // 5:ตามช่วงเวลา ครบจำนวน 6:ตามช่วงเวลา ครบมูลค่า ?>
                    ...
                    <th width="10%" class="text-right"><?php echo language('document/promotion/promotion', 'tBuyConditionCol'.$tPbyStaBuyCond); ?></th>
                    <th width="10%" class="text-right xCNHide"><?php echo language('document/promotion/promotion', 'tNotOver'); ?></th>
                <?php }else{ ?>
                    <th width="10%" class="text-right"><?php echo language('document/promotion/promotion', 'tBuyConditionCol'.$tPbyStaBuyCond); ?></th>
                    <th width="10%" class="text-right"><?php echo language('document/promotion/promotion', 'tNotOver'); ?></th>
                    <th width="10%" class="text-right"><?php echo language('document/promotion/promotion', 'tMinimumPrice_Unit'); ?></th>
                <?php } ?>
                
                <th width="12%" class="text-left"><?php echo language('document/promotion/promotion', 'tGetConditions'); ?></th>
                <th width="10%" class="text-right"><?php echo language('document/promotion/promotion', 'tValue'); ?></th>
                <th width="10%" class="text-right"><?php echo language('document/promotion/promotion', 'tAmountToReceive'); ?></th>
                <th width="10%" class="text-right"><?php echo language('document/promotion/promotion', 'tAveragePercentDiscount'); ?></th>
        ...
        <tbody class="xCNPromotionStep3RangeTbody">
            <?php if ($aDataList['rtCode'] == 1) { ?>
                <?php foreach ($aDataList['raItems'] as $key => $aValue) { ?>
                    <tr class="xCNTextDetail2 xCNPromotionStep3PmtCBWithPmtCGRow <?php echo str_replace(" ","",$aValue['FTPmdGrpName']); ?>" 
                    ...
                    data-grp-name="<?php echo $aValue['FTPmdGrpName']; ?>">
                        ...
                        <?php if($tPbyStaBuyCond == "5" || $tPbyStaBuyCond == "6"){ // 5:ตามช่วงเวลา ครบจำนวน 6:ตามช่วงเวลา ครบมูลค่า ?>
                            <td class="text-left">
                                ...
                                <!-- <input class="form-control xCNApvOrCanCelDisabledPmtCBWithPmtCG xCNPromotionStep3PbyMinTime" type="time" placeholder="00:00" min="00:00" max="23:59" value="<?php echo $aValue['FTPbyMinTime']; ?>"> -->
                            </td>
                            <td>
                                <div class="xCNPromotionStep3TimeContainer">
                                    <?php 
                                ...
                                <!-- <input class="form-control xCNApvOrCanCelDisabledPmtCBWithPmtCG xCNPromotionStep3PbyMaxTime" type="time" placeholder="00:00" min="00:00" max="23:59" value="<?php echo $aValue['FTPbyMaxTime']; ?>"> -->
                            </td>
                            <?php if($tPbyStaBuyCond == "5" || $tPbyStaBuyCond == "6"){ // 5:ตามช่วงเวลา ครบจำนวน 6:ตามช่วงเวลา ครบมูลค่า ?>
                                <td class="text-left">
                                    <input 
                                    type="text" 
                                    class="form-control text-right xCNInputNumeric xCNInputWithoutSpc xCNApvOrCanCelDisabledPmtCBWithPmtCG xCNPromotionCBPbyMinValue"
                                    maxlength="14"
                                ...
                                <td class="text-left xCNHide">
                                    <input 
                                    type="text" 
                                    class="form-control text-right xCNInputNumeric xCNInputWithoutSpc xCNApvOrCanCelDisabledPmtCBWithPmtCG xCNPromotionCBPbyMaxValue"  
                                    maxlength="14" 
                                    value="0">
                                </td>
                            <?php } ?>
                        <?php }else{ ?>
                            ...
                            <td class="text-left">
                                <input 
                                type="text" 
                                class="form-control text-right xCNInputNumeric xCNInputWithoutSpc xCNApvOrCanCelDisabledPmtCBWithPmtCG xCNPromotionCBPbyMinSetPri"  
                                maxlength="14"
                        ...
                        <td class="text-left">
                            <select class="xCNApvOrCanCelDisabledPmtCBWithPmtCG form-control xCNPromotionStep3CGPgtStaGetType">
                                <option value='1' <?php echo ($aValue['FTPgtStaGetType'] == '1') ? 'selected' : ''; ?>><?php echo language('document/promotion/promotion', 'tBahtDiscount'); ?></option>
                                <option value='2' <?php echo ($aValue['FTPgtStaGetType'] == '2') ? 'selected' : ''; ?>><?php echo language('document/promotion/promotion', 'tPercentDiscount'); ?></option>
                                <option value='3' <?php echo ($aValue['FTPgtStaGetType'] == '3') ? 'selected' : ''; ?>><?php echo language('document/promotion/promotion', 'tAdjustThePrice'); ?></option>
                                <option value='4' <?php echo ($aValue['FTPgtStaGetType'] == '4') ? 'selected' : ''; ?>><?php echo language('document/promotion/promotion', 'tUsePriceGroup'); ?></option>
                                <option value='5' <?php echo ($aValue['FTPgtStaGetType'] == '5') ? 'selected' : ''; ?>><?php echo language('document/promotion/promotion', 'tFree'); ?></option>
                                <!-- <option value='6' <?php echo ($aValue['FTPgtStaGetType'] == '6') ? 'selected' : ''; ?>><?php echo language('document/promotion/promotion', 'tIndeterminate'); ?></option> -->
                            </select>
                        </td>
                        <td class="text-left">
                            ...
                            <?php }else{ ?>
                                ...
                                type="text"
                                class="text-right form-control xCNInputWithoutSpc xCNApvOrCanCelDisabledPmtCBWithPmtCG xCNPromotionStep3PgtGetvalue xCNInputMaxValue xCNInputLength <?php echo $tNumberFormatControl; ?>"  
                                data-length="14"
                        ...
                        <td>
                            ...
                            type="text" 
                            class="form-control text-right xCNPromotionPgtGetQty xCNInputNumeric xCNInputWithoutSpc xCNApvOrCanCelDisabledPmtCG xCNInputLength"  
                            maxlength="14"
                            data-length="14"
                        ...
                        <td>
                            <input 
                            type="text" 
                            class="form-control text-right xCNPromotionPgtPerAvgDisCBWithCG xCNInputNumeric xCNInputWithoutSpc xCNApvOrCanCelDisabledPmtCBWithPmtCG xCNInputMaxValue xCNInputLength"  
                            maxlength="5"
                            data-length="5" 
                            data-max="100"
