        ...
        if(!bIsApvOrCancel){
            ...
            $('#otbPromotionStep3PmtCGTable .xCNPromotionStep3PgtStaGetType').unbind().bind('change', function(){
                ...
                if(bIsPgtStaGetTypeOfFree){ // เป็นของแถม Default 1
                    $(this).parents('.xCNPromotionStep3PmtCGRow').find('.xCNPromotionPgtGetQty').val("1");
                }else{ // ไม่ใช่ของแถม Default 0
                    $(this).parents('.xCNPromotionStep3PmtCGRow').find('.xCNPromotionPgtGetQty').val("0");
                }

                $(this).parents('.xCNPromotionStep3PmtCGRow').find('.xCNPromotionStep3PgtGetvalue').val("0");
        ...
        if (typeof nStaSession !== "undefined" && nStaSession == 1) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    tPgtPerAvgDisCG: (tPgtPerAvgDisCG == '')?0:tPgtPerAvgDisCG,
