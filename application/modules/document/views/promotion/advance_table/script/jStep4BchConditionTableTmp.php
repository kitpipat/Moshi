<script>
    ...
    $(document).ready(function(){
        ...
        if(bIsApvOrCancel){
            ...
            // $('form .xCNApvOrCanCelDisabledPdtPmtHDBch').attr('disabled', false);
            // $('#otbPromotionStep4BchConditionTable .xCNIconDel').removeClass('xCNDocDisabled');
            // $('#otbPromotionStep4BchConditionTable .xCNIconDel').attr('onclick', 'JSxPromotionStep4BchConditionDataTableDeleteByKey(this)');
        }

        if(!bIsApvOrCancel && tUserLoginLevel == "HQ"){
            $('#otbPromotionStep4BchConditionTable .xCNIconDel').attr('onclick', 'JSxPromotionStep4BchConditionDataTableDeleteByKey(this)');
        }
