<script>
    ...
    $(document).ready(function(){
        ...
        if(bIsApvOrCancel){
            $('form .xCNApvOrCanCelDisabledPmtCB').attr('disabled', true);
        }else{
            $('form .xCNApvOrCanCelDisabledPmtCB').attr('disabled', false);
        }
        ...
        if (typeof nStaSession !== "undefined" && nStaSession == 1) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    tPgtPerAvgDisCB: (tPgtPerAvgDisCB == '')?0:tPgtPerAvgDisCB,
                    nSeqNo: nSeqNo,
