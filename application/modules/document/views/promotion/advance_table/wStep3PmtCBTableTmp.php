    ...
    <table class="table table-striped xWPdtTableFont" id="otbPromotionStep3PmtCBTable">
        <thead>
            <tr>
                ...
                <th width="25%" class="text-left"><?php echo language('document/promotion/promotion', 'tListGroupName'); ?></th>
                <th width="10%" class="text-center"><?php echo language('document/promotion/promotion', 'tConditions'); ?></th>
                <th width="15%" class="text-right"><?php echo language('document/promotion/promotion', 'tBuyConditionCol'.$tPbyStaBuyCond); ?></th>
                <th width="15%" class="text-right"><?php echo language('document/promotion/promotion', 'tNotOver'); ?></th>
                <th width="15%" class="text-right"><?php echo language('document/promotion/promotion', 'tMinimumPrice_Unit'); ?></th>
            ...
            <?php if ($aDataList['rtCode'] == 1) { ?>
                <?php foreach ($aDataList['raItems'] as $key => $aValue) { ?>
                    <tr class="xCNTextDetail2 xCNPromotionPmtCBRow" data-seq-no="<?php echo $aValue['FNPbySeq']; ?>">
                        ...
                        <td class="text-center"><?php echo language('document/promotion/promotion', 'tBuyCondition' . $aValue['FTPbyStaBuyCond']); ?></td>
                        <td>
                            <input 
                            type="text" 
                            class="form-control text-right xCNInputNumeric xCNInputWithoutSpc xCNApvOrCanCelDisabledPmtCB xCNPromotionPbyMinValue xCNInputLength"
                            maxlength="14" 
                            data-length="14"
                        ...
                        <td>
                            <input 
                            type="text" 
                            class="form-control text-right xCNInputNumeric xCNInputWithoutSpc xCNApvOrCanCelDisabledPmtCB xCNPromotionPbyMaxValue xCNInputLength"  
                            maxlength="14" 
                            data-length="14"
                        ...
                        <td>
                            <input 
                            type="text" 
                            class="form-control text-right xCNInputNumeric xCNInputWithoutSpc xCNApvOrCanCelDisabledPmtCB xCNPromotionPbyMinSetPri xCNInputLength"  
                            maxlength="14"
                            data-length="14"
                        ...
                        <td>
                            <input 
                            type="text" 
                            class="form-control text-right xCNPromotionPgtPerAvgDisCB xCNInputNumeric xCNInputWithoutSpc xCNApvOrCanCelDisabledPmtCB xCNInputMaxValue xCNInputLength"  
                            maxlength="5"
                            data-max="100"
                            data-length="5" 
