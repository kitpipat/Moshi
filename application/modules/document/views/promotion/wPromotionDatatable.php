                ...
                <tbody id="odvRGPList">
                    <?php if ($aDataList['rtCode'] == 1) { ?>
                        <?php foreach ($aDataList['raItems'] as $key => $aValue) { ?>
                            ...
                            $bIsApproved = ($aValue['FTPmhStaApv'] == 1 || $aValue['FTPmhStaApv'] == 2);
                            ?>
                            ...
                            <tr class="text-center xCNTextDetail2" id="otrPromotionHD<?= $key ?>" data-code="<?= $aValue['FTPmhDocNo'] ?>" data-name="<?= $aValue['FTPmhDocNo'] ?>">
                                ...
                                <td class="text-left"><label class="xCNTDTextStatus <?= $tClassStaDoc ?>"><?php echo language('document/promotion/promotion', 'tStaDoc' . $aValue['FTPmhStaDoc']) ?></label></td>
                                <td class="text-left"><label class="xCNTDTextStatus <?= $tClassStaApv ?>"><?= language('document/promotion/promotion', 'tStaApv' . $aValue['FTPmhStaApv']) ?></label></td>
                                <td class="text-left"><label class="xCNTDTextStatus <?= $tClassPrcStk ?>"><?php echo language('document/promotion/promotion', 'tStaPrcStk' . $aValue['FTPmhStaApv']) ?></label></td>
