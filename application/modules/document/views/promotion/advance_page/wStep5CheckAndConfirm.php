                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <select 
                                                    class="selectpicker form-control xCNApvOrCanCelDisabledCheckAndConfirm" 
                                                    onchange="JSvPromotionStep5UpdatePmtCBStaCalSumInTemp(false, true)"
                                                    id="ocmPromotionStep5BuyPbyStaCalSum" 
                                                    name="ocmPromotionStep5BuyPbyStaCalSum">
                                                    ...
                                                    <label>
                                                        ...
                                                        <b>
                                                            ...
                                                            <?php if(in_array($tPbyStaBuyCond,["5","6"])) { // 6:ตามช่วงเวลา ครบจำนวน 7:ตามช่วงเวลา ครบมูลค่า ?>
                                                                <?php if($tPbyStaBuyCond == "5") { // 6:ตามช่วงเวลา ครบจำนวน ?>
                                                                    <?php echo ($aItemCB['FCPbyMinValue']>0)?language('document/promotion/promotion', 'tBuyCondition1'):''; ?>   
                                                                <?php } ?>
                                                                <?php if($tPbyStaBuyCond == "6") { // 7:ตามช่วงเวลา ครบมูลค่า ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <select 
                                                    class="selectpicker form-control xCNApvOrCanCelDisabledCheckAndConfirm" 
                                                    onchange="JSvPromotionStep5UpdatePmtCGPgtStaGetEffectInTemp(false, true)"
                                                    id="ocmPromotionStep5GetPgtStaGetEffect" 
                                                    name="ocmPromotionStep5GetPgtStaGetEffect">
                                                        <?php if($bConditionBuyIsRange){ ?>
                                ...
                                <tr>
                                    ...
                                    <td>  
                                        <?php foreach($aCouponInTmp as $aItemCoupon) { ?>
                                            ...
                                            $tGetText = "";
                                            if($tPgtStaCoupon == "1"){
                                                $tGetText = language('document/promotion/promotion', 'tN_Right');"n สิทธิ์";
                                                $tName = $aItemCoupon['FTCphDocName'];
                                                $tGetLabel = language('document/promotion/promotion', 'tGetCoupons');"รับคูปอง";
                                            }
                                            if($tPgtStaCoupon == "2"){
                                                $tGetText = language('document/promotion/promotion', 'tN_Right');"n สิทธิ์";
                                                $tName = $aItemCoupon['FTCphDocName'];
                                            ...
                                            if($tPgtStaCoupon == "3"){
                                                ...
                                                $tGetLabel = language('document/promotion/promotion', 'tGets');"ได้รับ";   
                                            }
                                            ?>
