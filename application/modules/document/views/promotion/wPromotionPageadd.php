						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<select class="selectpicker form-control" id="ocmPromotionPmhStaLimitCst" name="ocmPromotionPmhStaLimitCst" <?php echo ($bIsApvOrCancel)?'disabled':''; ?>>
										<option value='1' <?php echo ($tPmhStaLimitCst == "1")?'selected':''; ?>><?php echo language('document/promotion/promotion', 'ทั้งหมด'); ?></option>
										<option value='2' <?php echo ($tPmhStaLimitCst == "2")?'selected':''; ?>><?php echo language('document/promotion/promotion', 'สมาชิก'); ?></option>
									</select>
								</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									type="text" 
									class="form-control text-right xCNInputLength xCNInputWithoutSpc xCNApvOrCanCelDisabled" 
						...
						<div class="row">	
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select class="selectpicker form-control" id="ocmPromotionSpmStaLimitCst" name="ocmPromotionSpmStaLimitCst" <?php echo ($bIsPmhStaChkCstActive)?'':'disabled'; ?>>
										<option value='0' <?php echo ($tSpmStaLimitCst == "0")?'selected':''; ?>><?php echo language('document/promotion/promotion', 'tNotActive'); ?></option>
							...
							<div class="col-md-6">
								<div class="form-group text-right">
									...
									type="text" 
									class="form-control text-right xCNInputWithoutSpc xCNApvOrCanCelDisabled xCNInputNumericWithoutDecimal" 
						...
						<div class="row">	
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<?php echo ($bIsPmhStaChkCstActive)?'':'disabled'; ?>
									type="text" 
									class="form-control text-right xCNInputLength xCNInputNumericWithoutDecimal xCNInputWithoutSpc xCNApvOrCanCelDisabled" 
...
<?php if(!$bIsApvOrCancel) { ?>
	<!-- Begin Approve Doc -->
	<div class="modal fade" id="odvPromotionPopupApv">
