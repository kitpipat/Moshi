<script>
    ...
    /* $('#ocbPromotionStep3CouponControl, #ocbPromotionStep3PointControl, #ocbPromotionStep3GroupGetControl').bind('change', function(){
        ...
        if( JSbPromotionStep3GetCouponPointEmptyChecked() ){
            ...
            $(this).trigger("change");
            var tWarningMessage = 'กรุณาเลือกรายการ เงื่อนไขกลุ่มรับ, เงื่อนไข-สิทธิประโยชน์คูปอง, เงื่อนไข-สิทธิประโยชน์แต้ม อย่างน้อย 1 เงื่อนไข';
        ...
        $('#ocbPromotionStep3GroupGetControl').unbind().bind('change', function(){
            ...
            if( JSbPromotionStep3GetCouponPointEmptyChecked() ){
                ...
                if(bIsChecked){
                    ...
                    var tWarningMessage = 'กรุณาเลือกรายการ กำหนดกลุ่ม ซื้อ-รับ';
                    FSvCMNSetMsgWarningDialog(tWarningMessage);
    ...
    */
    function JCNbPromotionStep3AvgDisPercentIsValid() {
        ...
        if(JSbPromotionConditionBuyIsRange()){return true;} // ไม่มีการตรวจสอบข้อมูล % เฉลี่ยส่วนลด ในเงื่อนไขแบบการซื้อแบบช่วง
