                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div class="form-group" style="cursor:not-allowed">
                                    <input 
                                        ...
                                        maxlength="20"
                                        value="<?=$tTWIDocNo;?>"
                                        data-validate-required="<?=language('document/transferreceiptOut/transferreceiptOut', 'tTWIPlsEnterOrRunDocNo'); ?>"
                                        data-validate-duplicate="<?=language('document/transferreceiptOut/transferreceiptOut', 'tTWIPlsDocNoDuplicate'); ?>"
                                        placeholder="<?=language('document/transferreceiptOut/transferreceiptOut','tTWIDocNo');?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input
                                            ...
                                            name="oetTWIDocDate"
                                            value="<?=$dTWIDocDate;?>"
                                            data-validate-required="<?=language('document/transferreceiptOut/transferreceiptOut', 'tASTPlsEnterDocDate');?>"
                                        >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input
                                            ...
                                            name="oetTWIDocTime"
                                            value="<?=$dTWIDocTime;?>"
                                            data-validate-required="<?=language('document/transferreceiptOut/transferreceiptOut', 'tTWIPlsEnterDocTime');?>"
                                        >
                                        <span class="input-group-btn">
                                ...
                                <?php }else{ ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                <?php if($tTWIRoute == "dcmTXOOutEventEdit"){ $tDis = 'disabled'; }else{ $tDis = ''; } ?>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        <div id="odvINWhereSPL" style="display:none;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input name="oetTRINSplName" id="oetTRINSplName" class="form-control xCNClearValue" value="<?=$tTWISplName?>" type="text" readonly="" 
                                            ...
                                            <!-- <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="oetTRINShpName" id="oetTRINShpName" class="form-control xCNClearValue" value="<?=$tTWIShopName?>" type="text" readonly="" 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input name="oetTRINWahFromName" id="oetTRINWahFromName" class="form-control xCNClearValue" value="<?=$tTWIWhNameTo?>" type="text" readonly="" 
                                                            placeholder="<?= language('document/transferreceiptOut/transferreceiptOut', 'tTWIWahhouse') ?>" >
                                        ...
                                        <div id="odvINWhereETC" style="display:none;">
                                            ...
                                            <div class="form-group">
                                                <label class="xCNLabelFrm"><span style="color:red">*</span><?= language('document/transferreceiptOut/transferreceiptOut', 'tTWIWahhouse'); ?></label>
                                                <div class="input-group">
                                                    <input name="oetTRINWahEtcName" id="oetTRINWahEtcName" class="form-control xCNClearValue"  value="<?=$tTWIWhNameTo?>" type="text" readonly="" 
                                                            placeholder="<?= language('document/transferreceiptOut/transferreceiptOut', 'tTWIWahhouse') ?>" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input name="oetTWIReasonName" id="oetTWIReasonName" class="form-control" value="<?=$tTWIRsnName?>" type="text" readonly="" 
                                        placeholder="<?= language('document/transferreceiptOut/transferreceiptOut', 'tTWIReason') ?>">
