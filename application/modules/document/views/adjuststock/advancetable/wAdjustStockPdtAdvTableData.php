            ...
            <thead>
                <tr class="xCNCenter">
                    ...
                    <?php if((@$tASTStaApv == '') && @$tASTStaDoc != 3):?>
                        ...
                        <th class="xWDeleteBtnEditButton"><?php echo language('document/adjuststock/adjuststock','tASTTBEdit')?></th>
                    <?php else: ?>
                        <th></th>
                    <?php endif; ?>
                </tr>
            ...
            <tbody>
                ...
                <?php if($aDataDTList['rtCode'] == 1):?>
                    <?php foreach($aDataDTList['raItems'] as $DataTableKey => $aDataTableVal):?>
                        ...
                        <tr class="text-center xCNTextDetail2 xCNDOCPdtItem nItem<?php echo $nNumSeq;?>" data-index="<?php echo $aDataTableVal['rtRowID'];?>" data-seqno="<?php echo $aDataTableVal['FNXtdSeqNo'];?>">
                            ...
                            <?php foreach($aColumnShow as $DataKey => $DataVal): ?>
                                ...
                                <?php
                                    ...
                                    // Check Data All Diff
                                    if($tColumnName == 'FCAjdQtyAllDiff'){
                                        $tDataCol = ($aDataTableVal['FCAjdWahB4Adj'] + $aDataTableVal[$tColumnName])*1;
                                    }
                                ?>
                                ...
                                <?php else:?>
                                    <td nowrap class="<?php echo $tAlignFormat?>">
                                        <?php if($DataVal->FTShwStaAlwEdit == 1 && (empty($tASTStaApv) && $tASTStaDoc != 3)):?>
                                            <label class="xCNPdtFont xWShowInLine<?php echo $aDataTableVal['FNXtdSeqNo'];?> xWShowValue<?php echo $tColumnName;?><?php echo $aDataTableVal['FNXtdSeqNo'];?>">
