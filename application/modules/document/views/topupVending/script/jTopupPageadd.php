<script>
    ...
    $("#obtBrowseTopUpVendingPos").click(function() {
        ...
        window.oBrowseTopUpVendingPos = {
            ...
            CallBack: {
                ReturnType: 'S',
                Value: ["oetTopUpVendingPosCode", "TVDMPosShop.FTPosCode"],
                Text: ["oetTopUpVendingPosName", "TVDMPosShop.FTPosCode"],
            },
            NextFunc: {
    ...
    $("#obtBrowseTopUpVendingWah").click(function() {
        ...
        window.oBrowseTopUpVendingWah = {
            ...
            Where: {
                Condition: [
                    function() {
                        var tSQL = " AND TCNMShpWah.FTBchCode = '" + $("#oetTopUpVendingBCHCode").val() + "'";
                        // var tSQL =" AND TCNMWaHouse.FTWahStaType IN (2,3)";
            ...
            CallBack: {
                ReturnType: 'M',
                Value: ["oetTopUpVendingWahCode", "TCNMShpWah.FTWahCode"],
