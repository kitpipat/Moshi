...
<script type="text/javascript">
    ...
    $('#obtCreditNoteBrowseMch').click(function(){
        ...
        oCreditNoteBrowseMch = {
            ...
            Where: {
                Condition: ["AND (SELECT COUNT(FTShpCode) FROM TCNMShop WHERE TCNMShop.FTMerCode = TCNMMerchant.FTMerCode AND TCNMShop.FTBchCode = '"+$("#ohdCreditNoteBchCode").val()+"') != 0"]
            },
            GrideView: {
    ...
    $('#obtCreditNoteBrowseShp').click(function(){
        ...
        oCreditNoteBrowseShp = {
            ...
            Where:{
                Condition : [
                    function(){
                        var tSQL = "AND TCNMShop.FTBchCode = '"+$("#ohdCreditNoteBchCode").val()+"' AND TCNMShop.FTMerCode = '"+$("#oetCreditNoteMchCode").val()+"'";
                        return tSQL;
                    }
                ]
            },
    ...
    $('#obtCreditNoteBrowsePos').click(function(){
        ...
        oCreditNoteBrowsePos = {
            ...
            Where: {
                Condition: [
                    function(){
                        var tSQL = "AND TVDMPosShop.FTBchCode = '"+$("#ohdCreditNoteBchCode").val()+"' AND TVDMPosShop.FTShpCode = '"+$("#oetCreditNoteShpCode").val()+"'";
                        return tSQL;
                    }
                ]
            },
