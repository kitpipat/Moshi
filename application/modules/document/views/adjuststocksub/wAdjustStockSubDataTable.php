                ...
                <?php if($aDataList['rtCode'] == 1 ) : ?>
                    <?php foreach($aDataList['raItems'] AS $key=>$aValue) { ?>
                        ...
                        <tr class="text-center xCNTextDetail2 otrPurchaseoeder" id="otrPurchaseoeder<?=$key?>" data-code="<?=$aValue['FTAjhDocNo']?>" data-name="<?=$aValue['FTAjhDocNo']?>">
                            ...
                            <td class="text-left"><label class="xCNTDTextStatus <?=$tClassStaDoc?>"><?php echo language('document/adjuststocksub/adjuststocksub','tAdjStkSubStaDoc'.$aValue['FTAjhStaDoc']) ?></label></td>
                            ...
                            <td class="text-left"><?= language('document/adjuststocksub/adjuststocksub', 'tAdjStkSubStaApv'.$aValue['FTXthApvCode'])?></td> 
                            <?php if($aAlwEvent['tAutStaFull'] == 1 || $aAlwEvent['tAutStaDelete'] == 1) : ?>
                                <td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <!-- แก้ -->
                <button id="osmConfirm" onClick="JSnDelChoose()" class="btn xCNBTNPrimery xCNBTNPrimery2Btn" type="button">
