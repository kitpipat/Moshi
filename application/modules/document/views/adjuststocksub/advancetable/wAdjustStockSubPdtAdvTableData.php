                          ...
                          <td nowrap class="<?=$tAlignFormat?>">
                            <?php if($DataVal->FTShwStaAlwEdit == 1){ ?>
                                ...
                                <div class="xCNHide xWEditInLine<?=$aDataTableVal['FNXtdSeqNo']?>">
                                    <input 
                                        type="<?=$InputType?>" 
                                        class="form-control xCNPdtEditInLine xWValueEditInLine<?=$aDataTableVal['FNXtdSeqNo']?> <?=$tValidateType?> xCNInputWithoutSpc" 
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="xWPageAdjStkSubPdt btn-toolbar pull-right">
            ...
            <button onclick="JSvAdjStkSubPdtClickPage('previous')" class="btn btn-white btn-sm" <?php echo $tDisabledLeft ?>> 
            ...
            <button onclick="JSvAdjStkSubPdtClickPage('next')" class="btn btn-white btn-sm" <?php echo $tDisabledRight ?>> 
