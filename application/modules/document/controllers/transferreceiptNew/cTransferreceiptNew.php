    ...
    public function FSoCTWIAddEventDoc(){
        try {
            ...
            $aDataMaster = array(
                ...
                'FTXthRefInt'           => $aDataDocument['oetTWIRefIntDocNo'], 
    ...
    public function FSaCTWIRefDoc(){
        try{
            ...
            $aDataWhereDelete = array(
                'tBchCode'      => $this->session->userdata('tSesUsrLevel') == 'HQ' ? $this->input->post('tTWIBchCode') : $this->session->userdata('tSesUsrBchCode'),
