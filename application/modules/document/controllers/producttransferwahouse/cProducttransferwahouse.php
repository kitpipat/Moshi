...
class cProducttransferwahouse extends MX_Controller
{
    ...
    public function FSvCTFWAddPdtIntoTableDT()
    {
        ...
        for ($nI = 0; $nI < count($aPdtData); $nI++) {
            ...
            $aDataPdtMaster     =   $this->mProducttransferwahouse->FSaMTFWGetDataPdt($aDataPdtWhere); // Data Master Pdt





            $nStaInsPdtToTmp    =   $this->mProducttransferwahouse->FSaMTFWInsertPDTToTemp($aDataPdtMaster, $aDataPdtWhere);
        }
    ...
    */
    public function FSvCTFWVatLoadData()
    {
        ...
        $aDataVatDT     = $this->mProducttransferwahouse->FSaMTFWGetVatDTTemp($aDataWhere);
