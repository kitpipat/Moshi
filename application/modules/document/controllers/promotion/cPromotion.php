...
class cPromotion extends MX_Controller
{
    ...
    {   
        ...
        if($tUserLevel != "HQ"){ // In BCH or SHP
            ...
            if($bIsNoRecord){
                $tBchCodeLogin = $this->session->userdata("tSesUsrBchCode");
                $tBchNameLogin = $this->session->userdata("tSesUsrBchName");
    ...
    public function FSvCPromotionEditPage()
    {
        ...
        $this->mPromotion->FSaMPdtPmtHDCstLevToTemp($aDataToTempParams);
