                ...
                success: function(tResult) {
                    ...
                    if(aDataReturn['nStaEvent'] == '1'){
                        ...
                        switch(nCouponStaCallBack){
                            case 1 :
                                JSvRDHCallPageEditDocument(tCouponCoderReturn);
                            break;
                            case 2 :
                                JSvRDHCallPageAddDocument();
                            break;
...
//Return : View
//Return Type : View
function JSvRDHCallPageEditDocument(ptRDHDocNo) {
   JCNxOpenLoading();
    $.ajax({
        type: "POST",
        url: "dcmRDHPageEdit",
        data: { tRDHDocNo : ptRDHDocNo },
        cache: false,
        timeout: 0,
    ...
    if(pbIsConfirm){
        ...
        $.ajax({
            ...
            success: function(oDataReturn){
                JSvRDHCallPageEditDocument(tDocumentNumber);
                JCNxCloseLoading();
            },
            error: function(jqXHR, textStatus, errorThrown) {
        ...
        $.ajax({
            ...
            data: {
               ...
               // SPL: [$("#oetRDHFrmSplCode").val(),$("#oetRDHFrmSplCode").val()],
                BCH: [$("#ohdRDHUsrBchCode").val(),$("#ohdRDHUsrBchCode").val()],
