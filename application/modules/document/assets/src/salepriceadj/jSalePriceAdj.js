        ...
        $.ajax({
            ...
            success: function(tResult){
                ...
                $('#obtBtnPrint').bind("click",function(){
                    ...
                    window.open($("#ohdBaseUrl").val()+"formreport/ALLMPdtBillAdjustPrice?infor="+JCNtEnCodeUrlParameter(aInfor), '_blank');
                });
                // ============= Create By Witsarut 27/08/2019 Button Print ============= 
...
//Return : object Status Delete
//Return Type : object
function JSoSpaPdtPriDel(pnPage,ptDocNo,ptPdtCode,ptPunCode){
    ...
    if(typeof(nStaSession) !== 'undefined' && nStaSession == 1){
        ...
        $.ajax({
            ...
            data: {
                ...
                'SPL'             : ['',''],
                'BCH'             : [$('#ohdBranchSalePrice').val(),''],//Code, Name
                'SHP'             : ['',''],
...
function JSxSpaSaveInLine(oElm){
    var nStaSession = JCNxFuncChkSessionExpired();
    if(typeof(nStaSession) !== 'undefined' && nStaSession == 1){
...
function JSxSPAShowOriginalPrice(pnSeq){
    ...
    if(typeof(nStaSession) !== 'undefined' && nStaSession == 1){
        ...
        $.ajax({
            ...
            data: {
                ptFTPdtCode       : $('#ohdFTPdtCode'+pnSeq).val(),
