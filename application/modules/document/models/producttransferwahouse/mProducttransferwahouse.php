...
class mProducttransferwahouse extends CI_Model {
    ...
    */
    ...
    //     $tSQL = "SELECT * FROM TCNTPdtTwxHD WHERE FTXthDocNo = '".$ptDocNo."'";
    //     $oQuery = $this->db->query($tSQL);
    //     if($oQuery->num_rows() > 0){
    ...
    //     $tSQL = "SELECT * FROM TCNTPdtTwxHDRef WHERE FTXthDocNo = '".$ptDocNo."'";
    //     $oQuery = $this->db->query($tSQL);
    //     if($oQuery->num_rows() > 0){
    //         return $oQuery->row_array();
    //     }else{
    ...
    //     $tSQL = "SELECT * FROM TCNTPdtTwxDT WHERE FTXthDocNo = '".$ptDocNo."'";
    //     $oQuery = $this->db->query($tSQL);
    //     if($oQuery->num_rows() > 0){
