...
class mConditionRedeem extends CI_Model {
    ...
    public function FSaMRDHGetDataTableList($paDataCondition){
        ...
        if(isset($aDatSessionUserLogIn['FTBchCode']) && !empty($aDatSessionUserLogIn['FTBchCode'])){
            ...
            $tSQL   .=  "   AND RDHD.FTBchCode = '$tUserLoginBchCode' ";
        }
        ...
        if(isset($aDatSessionUserLogIn['FTShpCode']) && !empty($aDatSessionUserLogIn['FTShpCode'])){
            ...
            $tSQL   .=  "   AND RDHD.FTShpCode = '$tUserLoginShpCode' ";
        }
            ...
            $tUserLoginBchCode  = $aDatSessionUserLogIn['FTBchCode'];
                $tSQL  .="	OR (
                                ...
                                AND (
                                    ...
                                    OR (
                                        TARBCH.FTRdhBchTo ='$tUserLoginBchCode'
    ...
    public function FSnMRDHCountPageDocListAll($paDataCondition){
        ...
        $tSQL   =   "   SELECT 
                            COUNT(RDH.FTRdhDocNo) AS counts
        ...
        if(isset($aDatSessionUserLogIn['FTBchCode']) && !empty($aDatSessionUserLogIn['FTBchCode'])){
            $tUserLoginBchCode  = $aDatSessionUserLogIn['FTBchCode'];
            $tSQL   .=  "   AND RDH.FTBchCode = '$tUserLoginBchCode' ";
        }
        ...
        if(isset($tSearchStaApprove) && !empty($tSearchStaApprove)){
            if($tSearchStaApprove == 2){
                $tSQL   .= " AND (RDH.FTRdhStaApv = '$tSearchStaApprove' OR RDH.FTRdhStaApv = '' )";
            }else{
                $tSQL   .= " AND (RDH.FTRdhStaApv = '$tSearchStaApprove')";
            }
        }
        ...
        if(isset($tSearchStaPrcStk) && !empty($tSearchStaPrcStk)){
            if($tSearchStaPrcStk == 3){
                $tSQL .= " AND (RDH.FTRdhStaPrcDoc = '$tSearchStaPrcStk' OR RDH.FTRdhStaPrcDoc = '' OR RDH.FTRdhStaPrcDoc = NULL)";
            }else{
                $tSQL .= " AND (RDH.FTRdhStaPrcDoc = '$tSearchStaPrcStk')";
            }
        }
    ...
    public function FSnMRDHDelDocument($paDataDoc){
        ...
        // Document HDCstPri
        $this->db->where_in('FTRdhDocNo',$tDataDocNo);
        $this->db->delete('TARTRedeemHDCstLev');
    ...
    public function FSaMRDHGetDataByID($paData){
        ...
        if($tRdhDocNo!= ""){
            $tSQL .= "AND RDH.FTRdhDocNo = '$tRdhDocNo'";
        }
    ...
    public function FSaMRDHGetDataCDByID($paData){
        ...
        $aConditionRedeemCD = $this->db->where('FTRdhDocNo',$tRdhDocNo)->order_by('FNRdcSeq','ASC')->get('TARTRedeemCD')->result_array();
