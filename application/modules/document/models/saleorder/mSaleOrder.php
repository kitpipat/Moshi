...
public function FScMSOGetPricePdt4CstOrPdtBYPplCode($paData){
    ...
    // Return : Array Data Document HD
    // Return Type : array
    public function FSaMSOCopyData($paDataWhere){
        $tSODocNo        = $paDataWhere['tSODocNo'];
        $tSODocNoNew     = $paDataWhere['tSODocNoNew'];
        $tGetDis         = $paDataWhere['tGetDis'];

        //////////// Copy Doc HD //////////////////////
        $this->db->trans_begin();
        if($tGetDis == '1'){
        $tSql = "
        INSERT INTO TARTSoHD (
            FTBchCode,FTXshDocNo,FTShpCode,FNXshDocType,FDXshDocDate,FTXshCshOrCrd,FTXshVATInOrEx,FTDptCode,FTWahCode,FTPosCode,FTShfCode,FNSdtSeqNo,
            FTUsrCode,FTSpnCode,FTXshApvCode,FTCstCode,FTXshDocVatFull,FTXshRefExt,FDXshRefExtDate,FTXshRefInt,FDXshRefIntDate,FTXshRefAE,FNXshDocPrint,
            FTRteCode,FCXshRteFac,FCXshTotal,FCXshTotalNV,FCXshTotalNoDis,FCXshTotalB4DisChgV,FCXshTotalB4DisChgNV,FTXshDisChgTxt,FCXshDis,FCXshChg,
            FCXshTotalAfDisChgV,FCXshTotalAfDisChgNV,FCXshRefAEAmt,FCXshAmtV,FCXshAmtNV,FCXshVat,FCXshVatable,FTXshWpCode,FCXshWpTax,FCXshGrand,
            FCXshRnd,FTXshGndText,FCXshPaid,FCXshLeft,FTXshRmk,FTXshStaRefund,FTXshStaDoc,FTXshStaApv,FTXshStaPrcDoc,FTXshStaPaid,
            FNXshStaDocAct,FNXshStaRef,FDLastUpdOn,FTLastUpdBy,FDCreateOn,FTCreateBy
        ) 
        SELECT
            SOHD.FTBchCode,
            '$tSODocNoNew' AS FTXshDocNo,
            SOHD.FTShpCode,
            SOHD.FNXshDocType,
            CONVERT(DATETIME,'".date('Y-m-d H:i:s')."') AS FDXshDocDate,
            SOHD.FTXshCshOrCrd,
            SOHD.FTXshVATInOrEx,
            SOHD.FTDptCode,
            SOHD.FTWahCode,
            ...
            '' AS FTXshApvCode,
            SOHD.FTCstCode,
            SOHD.FTXshDocVatFull,
            SOHD.FTXshRefExt,
            SOHD.FDXshRefExtDate,
            SOHD.FTXshRefInt,
            SOHD.FDXshRefIntDate,
            SOHD.FTXshRefAE,
            SOHD.FNXshDocPrint,
            SOHD.FTRteCode,
            SOHD.FCXshRteFac,
            SOHD.FCXshTotal,
            SOHD.FCXshTotalNV,
            SOHD.FCXshTotalNoDis,
            SOHD.FCXshTotalB4DisChgV,
            SOHD.FCXshTotalB4DisChgNV,
            SOHD.FTXshDisChgTxt,
            SOHD.FCXshDis,
            SOHD.FCXshChg,
            SOHD.FCXshTotalAfDisChgV,
            SOHD.FCXshTotalAfDisChgNV,
            SOHD.FCXshRefAEAmt,
            SOHD.FCXshAmtV,
            SOHD.FCXshAmtNV,
            SOHD.FCXshVat,
            ...
            CONVERT(VARCHAR,'".$this->session->userdata('tSesUsername')."') AS FTCreateBy
            FROM
            TARTSoHD SOHD WITH (NOLOCK)
            WHERE
            SOHD.FTXshDocNo = '".$tSODocNo."'
    ";                 
        $oQuery = $this->db->query($tSql);

        //////////// Copy Doc DT //////////////////////
        $tSQL   = " INSERT INTO TARTSoDT (
            FTBchCode,FTXshDocNo,FNXsdSeqNo,FTPdtCode,FTXsdPdtName,FTPunCode,FTPunName,FCXsdFactor,FTXsdBarCode,FTSrnCode,
            FTXsdVatType,FTVatCode,FCXsdVatRate,FTXsdSaleType,FCXsdSalePrice,FCXsdQty,FCXsdQtyAll,FCXsdSetPrice,
            FCXsdAmtB4DisChg,FTXsdDisChgTxt,FCXsdDis,FCXsdChg,FCXsdNet,FCXsdNetAfHD,FCXsdVat,FCXsdVatable,FCXsdWhtAmt,
            FTXsdWhtCode,FCXsdWhtRate,FCXsdCostIn,FCXsdCostEx,FTXsdStaPdt,FCXsdQtyLef,FCXsdQtyRfn,FTXsdStaPrcStk,FTXsdStaAlwDis,
        ...
        SELECT
            ...
            SODT.FCXsdSetPrice,
            SODT.FCXsdAmtB4DisChg,
            NULL AS FTXsdDisChgTxt,
            0 AS FCXsdDis,
            0 AS FCXsdChg,
            SODT.FCXsdAmtB4DisChg AS FCXsdNet,
            SODT.FCXsdAmtB4DisChg AS FCXsdNetAfHD,
            SODT.FCXsdVat,
            SODT.FCXsdVatable,
            SODT.FCXsdWhtAmt,
            SODT.FTXsdWhtCode,
        ...
        //////////// Copy CSTDoc HD //////////////////////
        $tSql = "
            INSERT INTO TARTSoHDCst (
                FTBchCode,FTXshDocNo,FTXshCardID,FTXshCstName,FTXshCstTel,FTXshCardNo,FNXshCrTerm,FDXshDueDate,FDXshBillDue,FTXshCtrName,FDXshTnfDate,FTXshRefTnfID,
                FNXshAddrShip,FNXshAddrTax,FTXshStaAlwPosCalSo
            ) 
            SELECT
                SOHD.FTBchCode,
                '$tSODocNoNew' AS FTXshDocNo,
                ...
                SOHD.FNXshAddrShip,
                SOHD.FNXshAddrTax,
                SOHD.FTXshStaAlwPosCalSo
                FROM
                TARTSoHDCst SOHD WITH (NOLOCK)
                WHERE
                SOHD.FTXshDocNo = '".$tSODocNo."'
        ";                 
        $oQuery = $this->db->query($tSql);
