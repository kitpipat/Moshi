                ...
                <div class="col-xs-12 col-md-6 col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="fancy-checkbox">
                                <?php 
                                    if  (!isset($tCptStaUse) || $tCptStaUse != 1 )  : ?>
                                        <input type="checkbox" id="ocbCptcheck" name="ocbCptcheck"  value="1" checked> 
                                    <?php else: ?> 
                                        <input type="checkbox" id="ocbCptcheck" name="ocbCptcheck" checked="true" value="<?=$tCptStaUse?>"> 
                                    <?php endif; ?>
