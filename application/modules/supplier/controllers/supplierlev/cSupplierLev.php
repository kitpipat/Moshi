...
class cSupplierLev extends MX_Controller {
    ...
    public function FSoCSLVAddEvent(){
        ...
        try{
            ...
            if($aDataSupplierLevel['tIsAutoGenCode'] == '1'){ // Check Auto Gen Department Code?
                // Auto Gen Department Code
                $aGenCode = FCNaHGenCodeV5('TCNMSplLev','0');
                if($aGenCode['rtCode'] == '1'){
                    $aDataSupplierLevel['FTSlvCode'] = $aGenCode['rtSlvCode'];
                }
            }
