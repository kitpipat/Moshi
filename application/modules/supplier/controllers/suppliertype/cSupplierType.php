...
class cSupplierType extends MX_Controller {
    ...
    public function FSoCSTYAddEvent(){ 
        try{
            ...
            if($aDataSupplierType['tIsAutoGenCode'] == '1'){ // Check Auto Gen Department Code?
                // Auto Gen Department Code
                $aGenCode = FCNaHGenCodeV5('TCNMSplType','0');
                if($aGenCode['rtCode'] == '1'){
                    $aDataSupplierType['FTStyCode'] = $aGenCode['rtStyCode'];
                }
            }
