                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12">
                                <div class="form-group">   
                                        ...
                                        <input type="text" class="form-control xCNInputWithoutSpc" maxlength="100" id="oetSpnName" name="oetSpnName" value="<?= $tSpnName ?>"
                                        data-validate-required="<?php echo language('pos/saleperson/saleperson','tSPNNameValidate');?>">
                                </div>

                                <div class="form-group">
                                        <label class="xCNLabelFrm"><span style="color:red">*</span><?= language('pos/saleperson/saleperson','tSPNEmail')?></label>
                                        <input type="email" class="form-control xCNInputWithoutSpcNotThai" maxlength="100" id="oetSpnEmail" name="oetSpnEmail" value="<?= $tSpnEmail ?>"
                                        data-validate-required="<?php echo language('pos/saleperson/saleperson','tSPNEmailValidate');?>">
                                </div>
                                <div class="form-group">
