    ...
    <form class="contact100-form validate-form" action="javascript:void(0)" method="post" enctype="multipart/form-data" autocorrect="off" autocapitalize="off" autocomplete="off" id="ofmAddCustomerInfo1">
        ...
        <div class="row">
          ...
          <?php if($tRoute == "customerEventEdit"){ ?>
             <div class="col-xl-12 col-sm-4 col-md-4 col-lg-4">
                    <div class="form-group xMemBorderPoint" align="center">
                            ...
                            <br>
                            <?=number_format($nMemAmtActive['FCTxnBuyTotal'],FCNxHGetOptionDecimalShow())?>
                            <br>
                ...
                <div class="col-xl-12 col-sm-4 col-md-4 col-lg-4">
                    <div class="form-group xMemBorderPoint" align="center">
                        <label class="xCNLabelFrm"><?php echo language('customer/customer/customer','tCstMemBillActive'); ?></label>
                          <br>
                          <?=number_format($nMemAmtActive['FNTxnQtyBill'],0)?>
                            <br>
                        <label class="xCNLabelFrm"><?php echo language('customer/customer/customer','tCstMemUnitBill'); ?></label>
                    </div>
                </div>
          ...
          <?php } ?>
                ...
                <div class="form-group">
                        <label class="xCNLabelFrm"><?php echo language('customer/customer/customer','tCSTContactFax'); ?></label>
                        <input type="text" class="form-control" maxlength="100" id="oetCstFax" name="oetCstFax" value="<?=$tCstFax?>"
                        placeholder="<?php echo language('customer/customer/customer','tCSTContactFax'); ?>" 
                        autocomplete="off"
                    >
                </div>
                <div class="form-group">
