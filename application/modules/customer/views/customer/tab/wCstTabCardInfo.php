...
$tCstApply = empty($aResult['raCardInfo']['rtCstApply']) ? date('Y-m-d') : date('Y-m-d', strtotime($aResult['raCardInfo']['rtCstApply']));
$tCstCrdIssue = empty($aResult['raCardInfo']['rtCstCrdIssue']) ? date('Y-m-d') : date('Y-m-d', strtotime($aResult['raCardInfo']['rtCstCrdIssue']));
$tCstCrdExpire = empty($aResult['raCardInfo']['rtCstCrdExpire']) ? date('Y-m-d',strtotime('+1 year')) : date('Y-m-d', strtotime($aResult['raCardInfo']['rtCstCrdExpire']));
$tCstBchCode = empty($aResult['raCardInfo']['rtBchCode']) ? $this->session->userdata('tSesUsrBchCode') : $aResult['raCardInfo']['rtBchCode'];
$tCstStaAge = empty($aResult['raCardInfo']['rtCstStaAge']) ? "1" : $aResult['raCardInfo']['rtCstStaAge'];
$tCstBchName = empty($aResult['raCardInfo']['rtBchName']) ? $this->session->userdata('tSesUsrBchName') : $aResult['raCardInfo']['rtBchName'];
?>
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="hidden" id="oetCstCardBchCode" name="oetCstCardBchCode" maxlength="5" value="<?=$tCstBchCode?>"  data-validate="Please Insert Branch">
