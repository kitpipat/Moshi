...
<div class="row">
    ...
    <!--layout table-->
    <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
        <div id="odvTableContentPDT" style="min-height:350px;">

            <img src="<?=base_url()?>application/modules/common/assets/images//ada.loading.gif" class="xWImgLoading">
    ...
    function JSxGetPDTTable(pnPage){
        ...
        $.ajax({
            ...
            data    : {
                ...
                'nTotalResult'          : $('#ospAllPDTRow').text()
            },
            cache   : false,
            timeout : 0,
