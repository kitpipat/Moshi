...
class cBrowserPDTCallView extends MX_Controller
{
    ...
    public function FSxGetProductfotPDT(){
        ...
        if(!empty($this->session->userdata("tLangEdit"))){
           $tLangEdit = $this->session->userdata("tLangEdit");
        }else{
           $tLangEdit = $this->input->post("tInpLangEdit");
        }
    ...
    public function JSaCGetDataProduct($paData){
        $tFilter            = '';
        if(!empty($this->session->userdata("tSesUsrBchCom"))){
            $tBchSession        = $this->session->userdata("tSesUsrBchCom");
        }else{
            $tBchSession        = $this->input->post("tInpSesUsrBchCom");
        }
        // $tBchSession        = $this->session->userdata("tSesUsrBchCom");
        ...
        if($paData['tSPL'] != '' || $paData['tSPL'] != null){
            $tFilter .= " AND (Products.FTSplCode = '".$paData['tSPL']."')";
        }
