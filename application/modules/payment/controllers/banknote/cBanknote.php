...
class cBanknote extends MX_Controller {
    ...
    public function FSoCBNTAddEvent(){ 
        ...
        $nBntStaShw   = $this->input->post('ocbBntStaShw');
        ...
        $aDataBnt   = array(
            ...
            'FCBntRateAmt'  => $this->input->post('oetBntAmt'),
            'FTBntStaShw'   => $nBntStaShw,
        ...
        if($oCountDup !== FALSE && $nStaDup == 0){
            ...
            $aReturn = array(
                'nStaEvent'    => '801',
                'tStaMessg'    => language('common/mainmain','tDataDuplicate')
            );
        }
    ...
    public function FSoCBNTEditEvent(){ 
        ...
        $aDataBnt   = [
            ...
            'FTBntName'     => $this->input->post('oetBntName'),
            'FCBntRateAmt'  => str_replace(',','',$this->input->post('oetBntAmt')),
            'FTBntStaShw'   => $nBntStaShw,
            'FTBntRmk'      => $this->input->post('otaBntRemark'),
            'FDCreateOn'    => date('Y-m-d'),
            'FDLastUpdOn'   => date('Y-m-d'),
