            ...
            <table id="otbBntDataList" class="table table-striped"> <!-- เปลี่ยน -->
                <thead>
                    ...
                    <?php if($aAlwEventBankNote['tAutStaFull'] == 1 || ($aAlwEventBankNote['tAutStaAdd'] == 1 || $aAlwEventBankNote['tAutStaEdit'] == 1)) : ?>   
                        <th nowrap class="xCNTextBold text-center" style="width:10%;"><?php echo language('payment/banknote/banknote','tBNTTBChoose'); ?></th>
                    <?php endif;?>
                        <th nowrap class="xCNTextBold text-center" style="width:10%;"><?php echo language('payment/banknote/banknote','tBNTSelect'); ?></th>
                        <th nowrap class="xCNTextBold text-center" style="width:10%;"><?php echo language('payment/banknote/banknote','tBNTTBCode'); ?></th>
                        <th nowrap class="xCNTextBold text-center" style="width:30%"><?php echo language('payment/banknote/banknote','tBNTName');?></th>
                        <th nowrap class="xCNTextBold text-center" style="width:15%;"><?php echo language('payment/banknote/banknote','tBNTValue'); ?></th>
                    <?php if($aAlwEventBankNote['tAutStaFull'] == 1 || ($aAlwEventBankNote['tAutStaAdd'] == 1 || $aAlwEventBankNote['tAutStaEdit'] == 1)) : ?> 
                        <th nowrap class="xCNTextBold text-center" style="width:10%;"><?php echo language('payment/banknote/banknote','tBNTDelete'); ?></th>
                    <?php endif;?>
                    <?php if($aAlwEventBankNote['tAutStaFull'] == 1 || ($aAlwEventBankNote['tAutStaAdd'] == 1 || $aAlwEventBankNote['tAutStaEdit'] == 1)) : ?>
                        <th nowrap class="xCNTextBold text-center" style="width:10%;"><?php echo language('payment/banknote/banknote','tBNTEdit'); ?></th>
                    <?php endif;?>
                    </tr>
                </thead>
                <tbody>
