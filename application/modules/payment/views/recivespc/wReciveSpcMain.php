...
<div class="row">
    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
        <p style="font-weight: bold;"><?=language('payment/recivespc/recivespc','tDetailManagepayment')?></p>
    </div>
	...
	<?php if($aAlwEventRcvSpc['tAutStaFull'] == 1 || $aAlwEventRcvSpc['tAutStaDelete'] == 1 ) : ?>
        ...
        <?php endif; ?>
        <button id="obtSMLLayout" name="obtSMLLayout" class="xCNBTNPrimeryPlus" type="button" style="margin-left: 20px; margin-top: 0px;" onclick="JSvCallPageReciveSpcAdd()">+</button>
	</div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div id="odvContentRcvSpcDataTable"></div>
    </div>
</div>
