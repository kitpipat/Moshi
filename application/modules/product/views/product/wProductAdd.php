                ...
                <div class="tab-content">
                    ...
                    <div id="odvPdtContentInfo1" class="tab-pane fade active in">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-top:1%;">
                            <label class="xCNLabelFrm"><span class="text-danger">*</span> <?= language('creditcard/creditcard/creditcard','tCDCTBONIMG')?></label>
                                <div class="input-group colorpicker-component xCNSltColor col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                    <input class="form-control" type="text" id="oetPdtColor" name="oetPdtColor" maxlength="7" value="#">
                                    <span class="input-group-addon" id="ospCiolor" style="cursor: pointer;"></span>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-8 col-sm-6">
                                                    ...
                                                    <div class="row">
                                                        <!-- 
                                                            Last Update By : Napat(Jame) 04/05/2020 
                                                            ให้ภาษีขาย และ ภาษีซื้อ มี value เท่ากัน และให้แสดงเฉพาะภาษีขาย โดยเปลี่ยนชื่อ Label เป็น "มีภาษี"
                                                            จึง Display:none ภาษีซื้อไว้
                                                        -->
                                                        <div class="col-xs-3 col-sm-3" style="display:none;">
                                                            <!-- ภาษีซื้อ -->
                                                            <label class="fancy-checkbox">
                                                                    <script>
                                                        ...
                                                        <div class="col-xs-3 col-sm-3">
                                                            <!-- ภาษีขาย -->
                                                                ...
                                                                <span><?php echo language('product/product/product','tPDTStaVat1')?></span>
                                                                </label>
                                                            <!-- end ภาษีขาย -->                                  
                                                        </div>    
                                                        <div class="col-xs-3 col-sm-3">
...
<script type="text/javascript">
    $( document ).ready(function() {
        ...
        if(tcolor == "#"){
            ...
            $(".xCNColorProduct").css({'height':'230px','width':'100%','background-color' : tImgObj,'display': 'inline-block'}); 
    ...
    $( "#oimImgMasterProduct" ).change(function() {
         $("#oimImgMasterProduct").css({  'width' : '' });
    });

    $( "#oetPdtColor" ).change(function() {
        let tCodeColor = $(this).val(); 
        $('#oimImgMasterProduct').removeAttr('src');
        $(".xCNColorProduct").css({'height':'230px','width':'100%','background-color' : tCodeColor,'display': 'inline-block'}); 
        $(".xWTDImgDataItem").remove();
    });
    ...
    $( ".xCNCheckedORB" ).change(function() {
        ...
        $(".xWTDImgDataItem").remove();
        $("#oimImgMasterProduct").css({'width' : '' });
        $("#oimImgMasterProduct").css({ 'width' : '50%' });
        $('#oimImgMasterProduct').removeAttr('src');
        $(".xCNColorProduct").css({'height':'230px','width':'100%','background-color' : tNameColor,'display': 'inline-block'}); 
