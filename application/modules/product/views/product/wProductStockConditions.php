                    ...
                    <div class="form-group">
                        <label class="xCNLabelFrm"><span class="text-danger">*</span><?php echo language('product/product/product','tPdtStockConditionsBch')?></label>
                            <div class="input-group">
                                <input type="text" class="form-control xCNHide" id="oetStockConditionBchCode" name="oetStockConditionBchCode"  value="<?=$_SESSION['tSesUsrBchCode']?>" >
                                <input type="text" class="form-control xWPointerEventNone" id="oetStockConditionhBchName" name="oetStockConditionhBchName" value="<?=$_SESSION['tSesUsrBchName']?>"
