            ...
            <?php if(isset($aItems) && is_array($aItems) && !empty($aItems)):?>
                <?php foreach($aItems AS $key => $aValue):?>
                    ...
                    <tr id="otrPdtSetRow<?php echo $aValue['FTPdtCodeSet'];?>" class="xWPdtSetRow" data-pdtcode="<?php echo $aValue['FTPdtCodeSet'];?>" data-pdtname="<?php echo $aValue['FTPdtName'];?>">
                        ...
                        <td nowrap class="text-right"><?php echo number_format($cPdtCost,2)?></td>
                        <td nowrap class="text-right"><?php echo number_format($aValue['FCPstQty'],2)?></td>
                        <td nowrap class="text-right"><?php echo number_format($cPrice,2);?></td>
                        <td nowrap class="text-right"><?php echo number_format($cTotalPrice,2);?></td>
        ...
        <?php if(isset($aItems) && is_array($aItems) && !empty($aItems)):?>
            <thead>
                <tr>
                    ...
                    <th nowrap class="text-right xCNTextBold"><?php echo number_format($cSumPdtCost,2)?></th>
                    <th nowrap class="text-right xCNTextBold"><?php echo number_format($nSumQty,2)?></th>
                    <th nowrap class="text-right xCNTextBold"><?php echo number_format($cSumPrice,2);?></th>
                    <th nowrap class="text-right xCNTextBold"><?php echo number_format($cSumPriceTotal,2);?></th>
                    <th nowrap colspan="2"></th>
                </tr>
            </thead>
        <?php endif; ?>
