                            ...
                            <?php if($tProductCode != $aDataPdtVal['FTPdtCode']):?>
                                <tr class="xCNTextDetail2 xWPdtInfo xWPdtTr<?php echo $aDataPdtVal['FTPdtCode']?>" data-code="<?php echo $aDataPdtVal['FTPdtCode'];?>" data-name="<?php echo $aDataPdtVal['FTPdtName'];?>">
                                    ...
                                    <td nowrap class="xCNBorderRight xWPdtImgtd" rowspan="4" style="padding-right:10px !important">
                                        ...
                                        <?php else: ?>
                                           <div class="text-center"> <span  style="height:40px;width:100%;background-color:<?php echo $tStyleName ?>;display:inline-block;pandin"></span></div>
                                        <?php endif; ?>
                                    ...
                                    <?php foreach($aPdtColumnShw AS $nDataKey => $aDataVal):
                                        ...
                                        if($tColumnDataType == 'FC'){
                                            ...
                                            $tDataCol       = number_format($aDataPdtVal[$tColumnName],2);
...
<div class="row">
    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
        <p><?php echo language('common/main/main','tResultTotalRecord')?> <?php echo $aPdtDataList['rnAllRow']?> <?php echo language('common/main/main','tRecord')?> <?php echo language('common/main/main','tCurrentPage')?> <?php echo $aPdtDataList['rnCurrentPage']?> / <?php echo $aPdtDataList['rnAllPage']?></p>
    </div>
    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
        <div class="xWPageProduct btn-toolbar pull-right">
            <?php if($nPage == 1){ $tDisabledLeft = 'disabled'; }else{ $tDisabledLeft = '-';} ?>
            <button data-page="previous" class="btn btn-white btn-sm xCNBtnPagenation" <?php echo $tDisabledLeft ?>>
                <i class="fa fa-chevron-left f-s-14 t-plus-1"></i>
            </button>

            <?php for($i=max($nPage-2, 1); $i<=max(0, min($aPdtDataList['rnAllPage'],$nPage+2)); $i++){?>
                <?php 
                    if($nPage == $i){ 
                        $tActive = 'active'; 
            ...
            <button data-page="next" class="btn btn-white btn-sm xCNBtnPagenation" <?php echo $tDisabledRight ?>>
...
<script type="text/Javascript">
    ...
    $('.xCNBtnPagenation').click(function(){
        ...
        JSvProductClickPage(tNumberPage);
        return false;
    });
