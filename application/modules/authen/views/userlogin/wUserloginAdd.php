                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">	
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control xCNDatePicker xCNInputMaskDate text-left" id="oetUsrlogStart" name="oetUsrlogStart" value="<?php if($tUsrPwdStart != ""){ echo $tUsrPwdStart;}else{echo $dGetDataNow;}?>" >
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">	
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control xCNDatePicker xCNInputMaskDate text-left" id="oetUsrlogStop" name="oetUsrlogStop" value="<?php if($tPwdExpired != ""){ echo $tPwdExpired;}else{echo $dGetDataFuture;}?>">
                                <span class="input-group-btn">
