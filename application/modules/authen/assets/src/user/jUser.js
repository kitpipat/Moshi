    ...
    if(typeof(nStaSession) !== 'undefined' && nStaSession == 1){
        ...
        $('#ofmAddEditUser').validate({
            ...
            messages: {
                ...
                oetUsrPassword : {
                    "required"      : $('#oetUsrPassword').attr('data-validate-required'),
                    "dublicateCode" : $('#oetUsrPassword').attr('data-validate-dublicateCode')
                },
                oetUsrEmail : {
            ...
            submitHandler: function(form){
                ...
                tPassword       = $('#oetUsrPassword').val();

                if(tPassword == '******'){
                    $('#oetUsrPassword').val(tOldPassword);
                }else{
                    ...
                    if(tEncPassword == tOldPassword){
                        ...
                        $('#oetUsrPassword').val(tEncPassword);
                    }
                }
