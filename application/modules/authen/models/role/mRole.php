...
class mRole extends CI_Model
{
    ...
    public function FSaMGetFuncSettingList($paParams = [])
    {
        ...
        $tSQL = " 
            ...
            LEFT JOIN TCNTUsrFuncRpt USRFUNC WITH (NOLOCK) ON USRFUNC.FTGhdApp = HD.FTGhdApp AND USRFUNC.FTUfrGrpRef = HD.FTGhdCode AND USRFUNC.FTUfrRef = DT.FTSysCode AND USRFUNC.FTUfrType = '1' AND USRFUNC.FTRolCode = '$tRoleCode'
            
            WHERE DT.FTGdtStaUse = '1' 
            ORDER BY APL.FTAppName ASC, HD.FTKbdScreen ASC, DTL.FTGdtName ASC
        ";
