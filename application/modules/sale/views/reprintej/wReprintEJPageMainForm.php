...
<div class="row">
                                ...
                                <div class="xWEJBoxFilter">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control selectpicker" id="ocmEjDocumentType" name="ocmEjDocumentType">
                                            ...
                                            <option value="S"><?php echo language('sale/reprintej/reprintej','tEJDocumentTypeXSale');?></option>
                                            ...
                                            <option value="BNK"><?php echo language('sale/reprintej/reprintej','เอกาสารใบนำส่ง');?></option>
                                        </select>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="col-xs-12 col-sm-6 col-md-8 col-lg-8">
        <div class="panel panel-default" style="margin-bottom: 25px;">
            ...
            <div id="odvAbbrViewerData" class="panel-collapse collapse in" role="tabpanel" style="min-height: 670px;">
                <div class="panel-body">
                </div>
            </div>
        </div>
