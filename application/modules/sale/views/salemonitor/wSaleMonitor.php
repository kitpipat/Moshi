...
<input type="hidden" id="ohdSMTSALSessionBchCode" value="<?php echo $this->session->userdata('tSesUsrBchCode');?>">
<input type="hidden" id="ohdSMTSALSessionBchName" value="<?php echo $this->session->userdata('tSesUsrBchName');?>">
<input type="hidden" name="odhSMTSessionUserID" id="odhSMTSessionUserID" value="<?=$this->session->userdata('tSesSessionID')?>" >
<input type="hidden" name="odhSesUsrBchCode" id="odhSesUsrBchCode" value="<?=$this->session->userdata('tSesUsrBchCode')?>" >
