                            ...
                            <div class="col-xs-12 col-md-3 col-lg-3">
                                ...
                                <div class="col-xs-12 col-md-2 col-lg-2">
                                         <div class="form-group">
                                            ...
                                            <input type="text" class="form-control xCNHide" id="oetSMTSALFilterBchCode" name="oetSMTSALFilterBchCode">
                                            <input type="text" class="form-control xWPointerEventNone" id="oetSMTSALFilterBchName" name="oetSMTSALFilterBchName" readonly>
                                            <span class="input-group-btn">
                                            <button id="obtSMTSALFilterBch" type="button" class="btn xCNBtnBrowseAddOn"><img class="xCNIconFind"></button>
                                            </span>
                                            </div>
                                            </div>
                                </div>
                                <div class="col-xs-12 col-md-2 col-lg-2">
                                             <div class="form-group">
                                                ...
                                                <input type="text" class="form-control xCNHide" id="oetSMTSALFilterPosCode" name="oetSMTSALFilterPosCode">
                                                <input type="text" class="form-control xWPointerEventNone" id="oetSMTSALFilterPosName" name="oetSMTSALFilterPosName" readonly>
                                                <span class="input-group-btn">
                                                <button id="obtSMTSALFilterPos" type="button" class="btn xCNBtnBrowseAddOn"><img class="xCNIconFind"></button>
                                                </span>
                                                </div>
                                                </div>
                                </div>
...
<script type="text/javascript">
    ...
    $('#obtCallDataTable').click(function(){
      ...
      $('#obtSMTSALFilterBch').unbind().click(function(){
    ...
    $('#obtSMTSALFilterPos').unbind().click(function(){
            let nStaSession = JCNxFuncChkSessionExpired();
            if(typeof(nStaSession) !== 'undefined' && nStaSession == 1){
