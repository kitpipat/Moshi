                    ...
                    <form id="ofmBKLConditionFilter" class="validate-form" action="javascript:void(0)" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div id="odvBKLFilterShop" class="form-group">
                                ...
                                <div id="odvBKLFilterPos" class="form-group">
                                    ...
                                    <div class='input-group'>
                                        ...
                                        >
                                        <span class='input-group-btn'>
                                            <button id='obtBKLBrowsePos' type='button' class='btn xCNBtnBrowseAddOn' disabled><img class='xCNIconFind'></button>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div id="odvBKLFilterRack" class="form-group">
                                    ...
                                    <div class='input-group'>
                                        ...
                                        >
                                        <span class='input-group-btn'>
                                            <button id='obtBKLBrowseRack' type='button' class='btn xCNBtnBrowseAddOn' disabled><img class='xCNIconFind'></button>
                                        </span>
                                    </div>
                                </div>
                            </div>
