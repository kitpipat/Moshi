...
class cDashBoardSale extends MX_Controller
{
    ...
    public function index($nDSHSALBrowseType, $tDSHSALBrowseOption)
    {
        ...
        $aSetCookieRole = [];
        $tValueCookie = $this->input->cookie("Cookie_" . $this->session->userdata("tSesUserCode"), true);
        $aValCheck = json_decode($tValueCookie);

        $aIsAlwFuncInRoleParams = ["tUfrGrpRef" => "050", "tUfrRef" => "DSB01", "tGhdApp" => "SB"];
        ...
        $aIsAlwFuncInRoleParams = ["tUfrGrpRef" => "050", "tUfrRef" => "DSB02", "tGhdApp" => "SB"];
        $bChkRolePanelLeft1 = FCNbIsAlwFuncInRole($aIsAlwFuncInRoleParams);
        if ($bChkRolePanelLeft1 != 1) {
            $aSetCookieRole[1] = 0;
        } else {
        ...
        $aIsAlwFuncInRoleParams = ["tUfrGrpRef" => "050", "tUfrRef" => "DSB03", "tGhdApp" => "SB"];
        $bChkRolePanelLeft1 = FCNbIsAlwFuncInRole($aIsAlwFuncInRoleParams);
        if ($bChkRolePanelLeft1 != 1) {
            $aSetCookieRole[2] = 0;
        } else {
        ...
        $aIsAlwFuncInRoleParams = ["tUfrGrpRef" => "050", "tUfrRef" => "DSB04", "tGhdApp" => "SB"];
        $bChkRolePanelLeft1 = FCNbIsAlwFuncInRole($aIsAlwFuncInRoleParams);
        if ($bChkRolePanelLeft1 != 1) {
            $aSetCookieRole[3] = 0;
        } else {
        ...
        $aIsAlwFuncInRoleParams = ["tUfrGrpRef" => "050", "tUfrRef" => "DSB05", "tGhdApp" => "SB"];
        $bChkRolePanelLeft1 = FCNbIsAlwFuncInRole($aIsAlwFuncInRoleParams);
        if ($bChkRolePanelLeft1 != 1) {
            $aSetCookieRole[4] = 0;
        } else {
        ...
        $aIsAlwFuncInRoleParams = ["tUfrGrpRef" => "050", "tUfrRef" => "DSB06", "tGhdApp" => "SB"];
        $bChkRolePanelLeft1 = FCNbIsAlwFuncInRole($aIsAlwFuncInRoleParams);
        if ($bChkRolePanelLeft1 != 1) {
            $aSetCookieRole[5] = 0;
        } else {
        ...
        $aIsAlwFuncInRoleParams = ["tUfrGrpRef" => "050", "tUfrRef" => "DSB07", "tGhdApp" => "SB"];
        $bChkRolePanelLeft1 = FCNbIsAlwFuncInRole($aIsAlwFuncInRoleParams);
        if ($bChkRolePanelLeft1 != 1) {
            $aSetCookieRole[6] = 0;
        } else {
        ...
        $aIsAlwFuncInRoleParams = ["tUfrGrpRef" => "050", "tUfrRef" => "DSB08", "tGhdApp" => "SB"];
        $bChkRolePanelLeft1 = FCNbIsAlwFuncInRole($aIsAlwFuncInRoleParams);
        if ($bChkRolePanelLeft1 != 1) {
            $aSetCookieRole[7] = 0;
        } else {
        ...
        $aCookie = array(
            'name'   => "Cookie_" . $this->session->userdata("tSesUserCode"),
