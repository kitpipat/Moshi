            ...
            <table class="table table-striped" style="width:100%">
                ...
                <?php if($aDataList['rtCode'] == 1 ):?>
                    <?php foreach($aDataList['raItems'] AS $key=>$aValue){ ?>
                            ...
                            <td class="text-left"><?=$aValue['FTInfName']?></td>

                            <?php if($aValue['FTInfType'] == 1 ):?>
                            <td class="text-left"><?php echo language('interface/interfacehistory','tIFHImport'); ?></td>
                            <?php else:?>
                                <td class="text-left"><?php echo language('interface/interfacehistory','tIFHExport'); ?></td>
                                <?php endif; ?>
                                 
                            <td class="text-left"><?=$aValue['FTInfFile']?></td>
							<!-- <td class="text-center"><//?=$aValue ['FDHisDate']?></td>
                           	<td class="text-center"><//?=$aValue ['FDHisTime']?></td> -->
                            <td class="text-center"><?= date('Y-m-d', strtotime( $aValue ['FDHisDate']))?></td>
                           	<td class="text-center"><?= date('H:i:s', strtotime( $aValue ['FDHisTime']))?></td>
						
                            <?php if($aValue['FTStaDone'] == 1 ):?>
                            <td class="text-center"><lable class ="xCNTDTextStatus text-success"><?php echo language('interface/interfacehistory','tIFHSuccess'); ?></lable></td>
                            <?php else:?>
                                <td class="text-center "><lable class ="xCNTDTextStatus text-danger"><?php echo language('interface/interfacehistory','tIFHFail'); ?></lable></td>
                                <?php endif; ?>
                            <td class="text-left"><?=$aValue['FTHisDesc']?></td>
                            <td class="text-center">
                                ...
                                ?>
                                <a href="<?php echo base_url(); ?>application\modules\interface\views\interfacehistory\wInterfacehistoryDownload.php?pFile=<?=$aValue['FTInfFile']?>">
                                    <button type="button" <?php echo $tDisableButton;?> class="btn btn-primary xWIFXBtnDownload"><?php echo language('interface/interfacehistory','tIFHBtnDownload'); ?></button>
                                </a>
                            </td>
                        </tr>
                    <?php } ?>
