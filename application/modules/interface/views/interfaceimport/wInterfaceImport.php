						...
						<table id="otbCtyDataList" class="table table-striped"> <!-- เปลี่ยน -->
							<thead>
								<tr>
									...
									<th style="display:none" width="7%" nowrap class="text-center xCNTextBold"><?php echo language('interface/interfaceimport/interfaceimport','tIFSSelect'); ?></th>
							...
							<?php if(!empty($aDataMasterImport)){
								...
								<tr>
									...
									<td align="center" style="display:none">
										<input type="checkbox" class="progress-bar-chekbox" name="ocmINMImport[]" id="ocmINMImport1" checked value="1" idpgb="xWINM<?=$aData['FTInfCode']?>TextDisplay"  >
									</td>
									<td><?=$aData['FTInfName']?></td>
									<!-- <td >  
										<span id="ospINM<?=$aData['FTInfCode']?>ProgressBar" style="color:green;display:none" distext="<?=language('interface/interfaceimport/interfaceimport','tIFSImportSuccess')?>" ><?=language('interface/interfaceimport/interfaceimport','tIFSImportSuccess')?></span> -->
										
										<!-- <div class="xWINM<?=$aData['FTInfCode']?>TextDisplay xWINMTextDisplay" style="display:none;"
											 data-status 	= "2"
										...
										<div class="row xWINMProgress xWINM<?=$aData['FTInfCode']?>Progress" style="display:none;">
											<div class="col-md-1">
												<div class="loader simple-circle"></div>
											</div>
											<div class="col-md-9">
												<div class="odvINM<?=$aData['FTInfCode']?>TextProgress text-primary"><?=language('interface/interfaceimport/interfaceimport','tIFSImportProcess')?></div>
											</div>
										...
										<!-- <div class="progress" id="otdINM<?=$aData['FTInfCode']?>ProgressBar" style="margin-bottom:0px">
											<div class="progress-bar" id="odvINM<?=$aData['FTInfCode']?>ProgressBar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width:0%" status='1'>
												0%
											</div>
										</div>
  									</td> -->
...
<div class="modal fade" id="odvModalProgressRabbitMQ">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="xCNHeardModal modal-title" style="display:inline-block"><?=language('common/main/main', 'tMainSystemIsInProgress')?></h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
                <?php echo language('common/main/main', 'tImportExportProgress')?>
			</div>
