...
<?php
	if($this->session->userdata("tSesUsrLevel") != "HQ"){
		...
		// $tUserBchName = $this->session->userdata("tSesUsrBchNameCom");
	}
?>
						...
						<table id="otbCtyDataList" class="table table-striped"> <!-- เปลี่ยน -->
							...
							<tbody>
								<tr>
									...
									<td align="left"><?php echo $aDataMasterImport[0]['FTInfName'] ?></td>
									<td>
										<div class="col-md-12">
												...
												<div class="col-md-10">
													...
													<div id="odvCondition4" class="row">
														...
														<div class="col-lg-5">
															<div class="form-group">
																<div class="input-group">
																	<input type="text" class="form-control xWITFXDatePickerSale xCNDatePicker xCNDatePickerStart xCNInputMaskDate xWRptAllInput xWIFXDisabledOnProcess" autocomplete="off" id="oetITFXDateFromSale" name="oetITFXDateFromSale" maxlength="10">
																	<span class="input-group-btn">
														...
														<div class="col-lg-5">
															<div class="form-group">
																<div class="input-group">
																	<input type="text" class="form-control xWITFXDatePickerSale xCNDatePicker xCNDatePickerEnd xCNInputMaskDate xWRptAllInput xWIFXDisabledOnProcess" autocomplete="off" id="oetITFXDateToSale" name="oetITFXDateToSale" maxlength="10">
																	<span class="input-group-btn">
...
<script>
	...
	$('.xWITFXDatePickerSale').datepicker({
		format					: 'dd/mm/yyyy',
	...
	var oITFXBrowseSaleOption = function(poReturnInput){
		...
		if(dDateFrom != "" && dDateTo != ""){
			tWhere = " AND CONVERT(VARCHAR(10),TPSTSalHD.FDXshDocDate,121) BETWEEN CONVERT(VARCHAR(10),CONVERT(datetime,'" + dDateFrom +"',103),121) AND CONVERT(VARCHAR(10),CONVERT(datetime,'"+dDateTo+"',103),121)";
		}else{
			tWhere = " ";
		}
