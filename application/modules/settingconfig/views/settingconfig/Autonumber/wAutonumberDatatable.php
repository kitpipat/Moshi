...
<div class="row">
    <div class="col-md-12">
        <div class="table-responsive xCNTableScrollY xCNTableHeightAutonumber">
            <table class="table table-striped" style="width:100%" id="otbTableAutonumberDataTable">
                <thead>
					<tr class="xCNCenter">
						<th class="xCNTextBold" rowspan="2" style="text-align:justify; vertical-align: middle; width:100px;"><?= language('settingconfig/settingconfig/settingconfig','tTableNumber')?></th>
                        ...
                        <th class="xCNTextBold" rowspan="2" style="vertical-align: middle;  width:160px;"><?= language('common/main/main','tCMNActionEdit')?></th>
                    </tr>
                    <tr>
                        <th style="text-align:center;  width:260px;"><?= language('settingconfig/settingconfig/settingconfig','tTableFormat')?></th>
                        <th style="text-align:center;  width:260px;"><?= language('settingconfig/settingconfig/settingconfig','tTableResetPassword')?></th>
                        <th style="text-align:center;  width:260px;"><?= language('settingconfig/settingconfig/settingconfig','tTableFormat')?></th>
                        <th style="text-align:center;  width:260px;"><?= language('settingconfig/settingconfig/settingconfig','tTableResetPassword')?></th>
                    </tr>
                </thead>
