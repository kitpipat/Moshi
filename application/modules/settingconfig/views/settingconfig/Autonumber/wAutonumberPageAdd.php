                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group" style="width: 100%;">
                            <input class="xCNInputNumericWithDecimal" style="text-align: right;" name="oetFmtUsrNum" id="oetFmtUsrNum" maxlength="10" type="text" value="<?=$aAllowItem['raItems'][0]['FTSatDefNum']?>" autocomplete="off" placeholder="<?=language('settingconfig/settingconfig/settingconfig', 'tFmtUserStart'); ?>">
                        </div>
                    </div>
