    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="table-responsive xCNFuncSettingTableResponsive">
            <table id="otbFuncSettingTblDataTempList" class="table table-striped">
                <thead>
                    <tr class="xCNCenter">
                        <th width="10%" class="xCNTextBold"><?php echo language('setting/funcsetting/funcsetting', 'tFuncSettingSeq'); ?></th>
                        <th width="40%" class="xCNTextBold"><?php echo language('setting/funcsetting/funcsetting', 'tFuncSettingSys'); ?></th>
                        <th width="40%" class="xCNTextBold"><?php echo language('setting/funcsetting/funcsetting', 'tFuncSettingFuncGroup'); ?></th>
