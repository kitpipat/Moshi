                ...
                <div class="row">
                    ...
                    <div class="col-xs-8 col-sm-8">
                        ...
                        <div class="form-group">
                                ...
                                <input type="text" class="form-control xCNInputNumericWithDecimal" placeholder="<?php echo language('creditcard/creditcard/creditcard','tCDCChargingCard')?> %" maxlength="18" id="oetCrdChgPer" name="oetCrdChgPer" value="<?php if($tCrdChgPer != ''){ echo number_format(@$tCrdChgPer,2); }else{ echo "";}?>">
                        </div>
