<?php 
    ...
    if($aResult['rtCode'] == 1){
        ...
        if($tBbkBalance = ""){
            $tBalance =  number_format($tBbkBalance,2);
        }else{
            $tBalance =  "0.00";
        }
                                    ...
                                    <div id="" class="panel panel-default">
                                        <div class="panel-collapse collapse in" role="tabpanel">
                                            <div class="panel-body" style="padding-bottom:15px;">
                                                ...
                                                <?php else:?>
                                                    <i class="fa fa-refresh xWDSHSALFilter" style="cursor: pointer !important;" onClick="JSvCallPageBookBankEdit('<?php echo $tBbkCode;?>','<?php echo $tBbkType; ?>','<?php echo $tStaActive;?>')" aria-hidden="true" data-keyfilter="FBA"></i>
                                                <?php endif;?>
                                                </div>
                                    ...
                                    <label class="xCNLabelFrm"><span class="text-danger">*</span><?php echo language('bookbank/bookbank/bookbank','tBBKTablebanch')?></label>
                                        ...
                                        <span class="input-group-btn">
                                            <button id="obtBrowseBch" 
                                                    ...
                                                    <?php echo !empty($tBchCode) ? 'disabled' : '' ; ?> 
                                                    <?php echo $this->session->userdata("tSesUsrLevel") != 'HQ' ? 'disabled' : '' ; ?>>
...
$('#obtBrowseBnk').click(function(){JCNxBrowseData('oBrowseBnk');});
